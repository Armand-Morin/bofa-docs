# References with abstracts forQWIMproject: Reinforcement learning
...
1.2 UsingRLinQWIM........................................... 3
1.3 UsingRLinQWIM: Goals-based investing.............................. 4
1.4 UsingRLinQWIM: Asset allocation and portfolio construction.................. 5
...
reward: describes the goal of aRLproblem, and it is a scalar value (obtained from environment)
...
aligningMLproblem with investor objectives. RLis capable of handling real-world complexity of financial
...
- Das and Varma (“Dynamic Goals-Based Wealth Management using Reinforcement Learning,” 2020): use
    RLto solve for Goal Based InvestingGBI, with the solution converging to the solution obtained using
    dynamic programming
- Dixon and Halperin (“Goal-based wealth management with generative reinforcement learning,” 2021),
    ...
    ment Learning,” 2020):GBIapproach usingRL:
...
GIRL extends G-Learner within context of Inverse Reinforcement LearningIRL, where rewards col-
lected by agent are not observed, and should instead be inferred
```
- Fischer ( _Reinforcement learning in financial markets - a survey_ , 2018): RLcombines “prediction" and
...
- Irlam (“Machine learning for retirement planning,” 2020):RLis capable of handling real-world complexity
    of financial planning; taxes, inflation, longevity, etc.
- Irlam (“Machine learning for retirement planning,” 2020): financial and retirement planning viaDRL
...
- Benhamou et al. (“Adaptive learning for financial markets mixing model-based and model-free RL for
    volatility targeting,” 2021): bridges the gap betweenDRLand Modern Portfolio Theory, withDRLmap-
    ping directly market conditions to actions by design
- Benhamou et al. (“Adaptive learning for financial markets mixing model-based and model-free RL for
    volatility targeting,” 2021): augmented asset management viaDRL
...
based on deepRLare very data-hungry, slow to train, very sensitive to both the inputs and hyperparameters,
...
Given current state-of-the-art forRL, incorporating multiple goals with their corresponding priority levels
within aRL-based solution forGBIappears to be a significant modeling challenge. One possible solution may
leverage hierarchicalRLand curiosity-driven exploration.
...
List of references:
Aliaga-Diaz et al. ( _Vanguard’s Life-Cycle Investing Model (VLCM): A general portfolio framework for goals-
based investing_ , 2021)
...
2022)
Das et al. (“Dynamic optimization for multi-goals wealth management,” 2022)
Deguest et al. ( _Introducing a Comprehensive Investment Framework for Goals-Based Wealth Management_ ,
2015)
Dempster et al. (“Lifecycle Goal Achievement or Portfolio Volatility Reduction?” 2016)
...
Shalett ( _An Outcomes-Oriented Approach to Alternatives_ , 2015)
Wang et al. (“Portfolio Selection in Goals-Based Wealth Management,” 2011)
...
Dong et al. (“Factor Representation and Decision Making in Stock Markets Using Deep Reinforcement
Learning,” 2021)
...
Abbeel, P. and Ng, A. Y. (2017).“Inverse Reinforcement Learning.” In: _Encyclopedia of machine learning and
data mining_. Ed. by C. Sammut and G. I. Webb. Boston, MA: Springer US, pp. 678–682.
...
lenging real-world domain to test our approach. We demonstrate the utility of image-based data augmentation
...
measures will be monotone functions of the Sharpe ratio if portfolio returns follow the same location-scale
...
environments. We develop an exploration-exploitation algorithm that trades off costly solicitations of portfolio
...
in Reinforcement Learning.” In: _arXiv e-Print_.
...
complex market conditions particularly suited to study the dynamics of the financial market under various
scenarios.
...
problem size. The article elaborates how the current methods mitigate these challenges. We further discuss the
...
A brief survey.” In: _IEEE Signal Processing Magazine_ 34(6), pp. 26–38.
...
that look good on paper often disappoint in practice. Models and strategies suffering from overfitting typically
...
This page provides information and materials about ”Causal Reinforcement Learning ” (CRL), following
...
and Planning (with Python Bindings).” In: _Journal of Machine Learning Research_.
...
enable users not comfortable with C++ to take advantage of the library’s speed and functionality. AI-Toolbox
is free software, and is hosted online athttps://github.com/Svalorzen/{AI}-Toolbox.
Bartram, S. M., Branke, J., De Rossi, G., and Motahari, M. (2021).“Machine Learning for Active Portfolio
Management.” In: _The Journal of Financial Data Science_ 3(3), pp. 9–30.
...
with common financial indicators features like risk aversion, economic surprise index and correlations between
...
portfolio optimization methods like Markovitz and is able to detect and anticipate crisis like the current
COVID one.
...
available at our demo websitehttp://www.aisquareconnect.com/deeprl/models.html.
Benhamou, E., Saltiel, D., Ohana, J.-J., Atif, J., and Laraki, R. (2021c).“Deep Reinforcement Learning (DRL)
for Portfolio Allocation.” In: _SSRN e-Print_.
...
portfolio allocations. Results on test set show this approach can overperform traditional portfolio optimization
methods.
...
financial markets mixing model-based and model-free RL for volatility targeting.” In: _arXiv e-Print_.
...
maps directly market conditions to actions by design and hence should adapt to changing environment, (ii)
...
New Implementations.” In: _arXiv e-Print_.
...
an evaluation of Black Litterman, mean-variance, and naive diversification approaches.” In: _The European
Journal of Finance_ 23(1), pp. 1–30.
...
work. We provide empirical evidence that portfolio optimization utilizing industry return prediction models
...
Bjerring, T., Ross, O., and Weissensteiner, A. (2017).“Feature selection for portfolio optimization.” In: _Annals
of Operations Research_ 256, pp. 21–40.
...
Deep reinforcement learning (RL) has proved successful at solving challenging environments but often requires
...
this end, we present PyTorchRL, a PyTorch-based library for RL with a modular design that allows composing
agents from a set of reusable and easily extendable modules. Additionally, PyTorchRL permits the definition of
distributed training architectures with flexibility and independence of the Agent components. In combination,
...
applications.” In: _Proceedings of the AAAI Conference on Artificial Intelligence_ 33, pp. 7749–7758.
...
lem where the goal is to find the minimum number of demonstrations needed to specify the reward equivalence
...
implementation of our approach. Extensive empirical comparison of stochastic dominance models for portfolio
...
model is initially formulated as a Linear Program with exponentially many constraints, and then reformulated
...
quadrillion models.” In: _SSRN e-Print_.
...
in large scale problems. We apply our method to a very large set of factors proposed in the literature, and
...
Learning for Data Processing and Analytics.” In: _arXiv e-Print_.
...
In: _The Journal of Financial Data Science_ 3(1), pp. 10–27.
...
cost and the expected value of the square of the cost are tracked for different state/action combinations. This
...
Carbonneau, A. and Godin, F. (2021).“Equal risk pricing of derivatives with deep hedging.” In: _Quantitative
Finance_ 21(4), pp. 593–608.
...
Castro, P. S., Li, S., and Zhang, D. (2019).“Inverse Reinforcement Learning with Multiple Ranked Experts.”
In: _arXiv e-Print_.
...
review and propose various modifications to existing approaches and explore different techniques to succinctly


capture the market dynamics to model the markets. We then go on to use deep reinforcement learning to
...
Chhabra, A. B. (2015). _The Aspirational Investor: Taming the Markets to Achieve Your Life’s Goals_. Harper-
Business. 245 pp.
...
smarter choices about aligning your goals to your investment strategy. The Aspirational Investor is a practical,
...
Reinforcement Learning and Interpretable AI.” In: _SSRN e-Print_.
...
bels and potential market interactions. The resulting AlphaPortfolio yields stellar out-of-sample performances
...
tions in Asset Pricing.” In: _The Journal of Financial Data Science_ 3(1), pp. 28–42.
...
reinforcement learning algorithms using Bayesian optimization with behavioral cloning.” In: _arXiv e-Print_.
...
Portfolio Optimisation.” In: _31st International Conference on Automated Planning and Scheduling_.


Portfolio Selection (PS) is a perennial financial engineering problem that requires determining a strategy
...
avoiding drawdowns.” In: _SSRN e-Print_.
...
ment Learning Research.” In: _Journal of Machine Learning Research_ 22(131), pp. 1–5.
MushroomRL is an open-source Python library developed to simplify the process of implementing and running
...
wealth management.” In: _Journal of Banking & Finance_ 140 (106192).
...
estimation approach is developed to accommodate any number of derivative assets, solving a high dimensional
...
ment or Portfolio Volatility Reduction?” In: _The Journal of Portfolio Management_ 42(2), pp. 99–117.
...
fully dynamic strategy with the financial advisory industry’s representative current best practices. These
...
uation.” In: _Management Science_ 61(9), pp. 2185–2202.
...
The value of intertemporal hedge demands in strategic asset allocation appears negligible. The result is caused
...
This book introduces machine learning methods in finance. It presents a unified treatment of machine learning
and various statistical and computational disciplines in quantitative finance, such as financial econometrics
and discrete time stochastic control, with an emphasis on how theory and hypothesis tests inform the choice of
...
ment Learning.” In: _SSRN e-Print_.


We present a reinforcement learning approach to goal based wealth management problems such as optimiza-
...
gap, we develop a flexible and modularized framework, Baconian, which allows researchers to easily implement
...
Markets Using Deep Reinforcement Learning.” In: _arXiv e-Print_.
...
Option Replication and Hedging.” In: _The Journal of Financial Data Science_ 22(44), pp. 44–57.
...
learn similar or better strategies as compared to delta hedging. Out of all models, PPO performs the best in
...
empirical investigation of the challenges of real-world reinforcement learning.” In: _arXiv e-Print_.
...
guarantees of the Bellman equation. However, evidence from psychology, economics and neuroscience suggests
...
objectives of the investor. At the same time, important constraints, such as transaction costs, market liquidity,
...
publications, and categorizes them into three main approaches, i.e., critic-only approach, actor-only approach,
...
smart grids, finance, and many more. This manuscript provides an introduction to deep reinforcement learning
...
these methods. We propose a novel method for Inverse Reinforcement Learning that overcomes these problems
...
Inverse Reinforcement Learning.” In: _Journal of Artificial Intelligence Research_ 71, pp. 925–951.
...
with different players from those encountered during training. We further investigate conditions under which
...
mum variance portfolio estimation based on reinforcement learning.” In: _43rd International Convention on
Information, Communication and Electronic Technology (MIPRO)_. IEEE.
...
Although deep reinforcement learning has become a promising machine learning approach for sequential
...
Greiner, S. P. and Stoyanov, S. V. (2019).“Portfolio scoring by expected risk premium.” In: _The Journal of
Portfolio Management_ 45(4), pp. 83–90.
...
Empirical Approach.” In: _arXiv e-Print_.
...
under a linear regression model. Thirdly, we study the prediction power in two cases, single-step prediction and
...
out-of-sample assessment.” In: _Quantitative Finance_ 18(8), pp. 1425–1436.
...
Guo, D., Boyle, P. P., Weng, C., and Wirjanto, T. S. (2019).“When Does The 1/N Rule Work?” In: _SSRN
e-Print_.
...
wealth distribution.” In: _Quantitative Finance_ , pp. 1–15.
...
In: _Quantitative Finance_ 19(9), pp. 1543–1553.
...
Scholes (-Merton) (BSM) model’s idea of reducing the problem of option pricing and hedging to the problem of
...
a DP (model-based) solution, as well as versus the BSM model. Second, we develop an Inverse Reinforcement
...
by investment decisions of a bounded-rational agent. The agent acts in a stochastic market environment driven
...
rewards obtained by such self-playing market agent are not observed from market data, we formulate and solve
...
Learning for Asset Allocation Recommendations.” In: _arXiv e-Print_.
We suggest a simple practical method to combine the human and artificial intelligence to both learn best
investment practices of fund managers, and provide recommendations to improve them. Our approach is based
...
In contrast to classical stochastic control theory and other analytical approaches for solving financial decision-
...
to improve decisions in complex financial en- environments. This survey paper aims to review the recent
...
Finance Applications.” In: _The Review of Asset Pricing Studies_ 10(2), pp. 199–248.
...
Learning and Planning.” In: _arXiv e-Print_.
...
of what is still considered a black box. We evaluate mainly studies directly linking explainability to RL, and
...
asset environment for trading.” In: _arXiv e-Print_.
Financial trading has been widely analyzed for decades with market participants and academics always
looking for advanced methods to improve trading performance. Deep reinforcement learning (DRL), a recently
...
(GCRL), becomes especially challenging for long-horizon goals. Current methods have tackled this problem by
...
based graph. We further exploit SF to directly compute a goal-conditioned policy for inter-landmark traversal,
...
Distributed Reinforcement Learning.” In: _arXiv e-Print_.
Deep reinforcement learning has led to many recent-and groundbreaking-advancements. However, these ad-
vances have often come at the cost of both the scale and complexity of the underlying RL algorithms. Increases
...
scales of execution. Our aim is also to make the results of various RL algorithms developed in academia
...
code.
Hsu, Y.-C., Lin, H.-W., and Vincent, K. (2017). _Do Cross-Sectional Stock Return Predictors Pass the Test
without Data-Snooping Bias?_ Tech. rep. Institute of Economics Academia Sinica.
...
rule.” In: _Journal of Banking & Finance_ 97, pp. 257–269.
...
Dealing with estimation error is an important issue when we implement the mean-variance paradigm for
...
System for Financial Portfolio Management.” In: _arXiv e-Print_.
...
modularized and scalable architecture for portfolio management. MSPM involves two asynchronously updated
...
and dedicated solution to portfolio management that existing approaches do not. We also tackle data-shortage
...
_European Journal of Operational Research_ 265(1), pp. 372–388.
...
risk. However, for relatively large number of stocks in the portfolio, naive diversification maintains its superior
...
the quantitative concepts detailed here, the reader will find useful references to other works to develop an
in-depth understanding of an investment process.
Irlam, G. (2020a).“Machine learning for retirement planning.” In: _The Journal of Retirement_ 8(1), pp. 32–29.
...
Irlam, G. (2020b).“Multi Scenario Financial Planning via Deep Reinforcement Learning AI.” In: _SSRN e-Print_.
...
financial scenarios. Additionally AIPlanner is extended to produce results over the lifecycle, both pre and post
retirement, and for couples, as well as individuals. A reasonably realistic income tax model is incorporated.
And finally, a more realistic stock model is used. Over the lifecycle, compared to the best discovered alternative
...
learning for diversified portfolio construction by explainable AI.” In: _SSRN e-Print_.
...
ously. This article touches on several approaches in the extant literature that are well positioned to merge
...
arbitrage. Code athttps://github.com/sebjai/robust-risk-aware-rl.
...
Investing.” In: _The Journal of Wealth Management_ 16(1), pp. 23–32.
...
of Reinforcement Learning Algorithms.” In: _Thirty-seventh International Conference on Machine Learning
ICML_.


Performance evaluations are critical for quantifying algorithmic advances in reinforcement learning. Recent
reproducibility analyses have shown that reported performance results are often inconsistent and difficult to
replicate. In this work, we argue that the inconsistency of performance stems from the use of flawed evaluation
...
Kazak, E. and Pohlmeier, W. (2019).“Testing out-of-sample portfolio performance.” In: _International Journal
of Forecasting_ 35(2), pp. 540–554.
...
Kazak, E. and Pohlmeier, W. (2020). _Portfolio Pretesting with Machine Learning_. Tech. rep. University of
Lancaster.
...
Review and Perspectives.” In: _arXiv e-Print_.
...
and challenges in bridging the gap between the current state of continual RL and findings in neuroscience.
...
multi-stage stochastic goal programming.” In: _Quantitative Finance_ 20(3) (3), pp. 515–526.
...
Krishnan, S., Garg, A., Liaw, R., Miller, L., Pokorny, F. T., and Goldberg, K. (2016).“HIRL: Hierarchical
Inverse Reinforcement Learning for Long-Horizon Tasks with Delayed Rewards.” In: _arXiv e-Print_.
...
with the environments provided using the OpenAI Gym interface. This enables researchers to conduct scalable
...
at longer horizons – that we call a trajectory-based model. This trajectory-based model takes an initial state,
...
training code are available athttps://github.com/MishaLaskin/rad.
...
Environment and the MuJoCo physics simulation platform. We discuss the key differences of the various kinds


of algorithms, indicate their potential and limitations, as well as provide insights to researchers regarding
...
Gomez, A. (2019).“RL: Generic reinforcement learning codebase in TensorFlow.” In: _The Journal of Open
Source Software_ 4(42), p. 1524.
...
financial assets automatically using feature preprocessing skills and Recurrent Reinforcement Learning (RRL)
...
Hierarchical reinforcement learning (HRL) extends traditional reinforcement learning methods to complex
...
and Scalable Deep Reinforcement Learning for Quantitative Finance.” In: _ACM International Conference on
AI in Finance_.
...
trading agent in 10 minutes with 80 A100 GPUs, on NASDAQ-100 constituent stocks with minute-level data
over 10 years.
Liao, S.-L., Lin, S.-K., Kuang, X.-J., and Chen, T. (2022).“Portfolio Allocation with Dynamic Risk Preference
Via Reinforcement Learning: Evidence from the Taiwan 50 Index.” In: _SSRN e-Print_.
...
environment based on market data in an enhanced learning framework and identified portfolio allocation
...
Automate Trading in Quantitative Finance.” In: _SSRN e-Print_.
...
while alleviating the debugging work- loads. Thus, we help users pipeline the strategy design at a high turnover
...
costly densities with application to reinforcement learning.” In: _arXiv e-Print_.
This survey gives an overview of Monte Carlo methodologies using surrogate models, for dealing with densities
...
function may incur some computationally-expensive or even physical (real-world activity) cost, likely to give
...
Multi-asset Multi-factor Allocations.” In: _Machine Learning for Asset Management: New Developments and
...
complex and hard to implement. In this article, the author reduces the problem of selection bias in the context
...
Ma, Y. c. (, Wang, Z., and Fleiss, A. (2021).“Deep Q-Learning for Trading Cryptocurrency.” In: _The Journal
of Financial Data Science_ 3(3), pp. 121–127.
...
has exceptionally high potential to be employed and provides a solid foundation on which to build further
research.
...
variance efficiency.” In: _European Journal of Operational Research_ 290(3), pp. 1192–1206.
...
savvy Deep Reinforcement Learning for Portfolio Management.” In: _arXiv e-Print_.
...
tures. In particular, we introduce a new property, referred to as _asset permutation invariance_ , for portfolio
...
to the ability of the pension sponsors to support liabilities under reasonable investment expectations. The
...
and Agency: The Goals and Risk-based Asset Pricing Model.” In: _SSRN e-Print_.
...
So Well in Reinforcement Learning?” In: _arXiv e-Print_.
...
benefits, including learning over temporally extended transitions, exploring over temporally extended periods,
...
its Application in Different Fields.” In: _IEEE Access_ 8, pp. 209320–209344.
...
prehensive Deep Reinforcement Learning Framework.” In: _arXiv e-Print_.
...
directions, such as multi-agent and multi-objective learning, and human-machine interactions. Therefore, in
...
learning curve or limited flexibility that do not satisfy a need for fast prototyping in fundamental research.
...
Parker, F. J. (2016a).“Goal-Based Portfolio Optimization.” In: _The Journal of Wealth Management_ 19(3),
pp. 22–30.
...
Parker, F. J. (2016b).“Portfolio Selection in a Goal-Based Setting.” In: _The Journal of Wealth Management_
19(2), pp. 41–46.
...
Parker, F. J. (2020).“Allocation of wealth both within and across goals: a practitioner guide.” In: _The Journal
of Wealth Management_ 23(1), pp. 8–21.
...
Investing.” In: _The Journal of Impact and ESG Investing_ 1(3), pp. 27–38.
...
and Open Problems.” In: _arXiv e-Print_.
...
choices and has also yielded promising initial results when applied to RL. However, Automated Reinforcement
Learning (AutoRL) involves not only standard applications of AutoML but also includes additional challenges
...
for Model-based Reinforcement Learning.” In: _arXiv e-Print_.
...
lower the entry-bar of deploying state-of-the-art algorithms. MBRL-Lib is open-source athttps://github.
...
for distributed multi-agent reinforcement learning.” In: _arXiv e-Print_.
...
that DRL in stock trading has showed huge applicability potential rivalling professional traders under strong
...
ment Learning in R.” In: _The Journal of Open Source Software_ 4(38), p. 1087.
Reinforcement learning refers to a group of methods from artificial intelligence where an agentperforms
learning through trial and error (Sutton & Barto, 1998). It differs from supervisedlearning, since reinforcement
...
Bootstrap Method.” In: _Economic Themes_ 52(2).
...
number of shares forming the portfolio through bootstrap methodology. However, only through the traditional
optimization process could be attained optimum according to the required limits. Such effects can be observed
...
(SGD). The major drawback of the SGD methods is that they have the undesirable effect of not escaping sad-
...
for Generalization in Deep Reinforcement Learning.” In: _arXiv e-Print_.
...
do not affect the agent, such as the background. Our implementation is available athttps://github.com/
rraileanu/auto-drac.
...
These presentation slides have been written for the Advanced Course in Asset Management (theory and
...
Financial portfolio management is one of the problems that are most frequently encountered in the investment
...
A. (2021).“Pretraining Representations for Data-Efficient Reinforcement Learning.” In: _arXiv e-Print_.
...
on Atari games (equivalent to two hours of human experience), our approach significantly surpasses prior work
combining offline representation pretraining with task-specific finetuning, and compares favourably with other
...
Shalett, L. (2015). _An Outcomes-Oriented Approach to Alternatives_. Tech. rep. Morgan Stanley Wealth Man-
agement.
...
However, the agent’s decision-making process is generally not transparent. The lack of interpretability hinders
the applicability of RL in safety-critical scenarios. In this paper, we propose a self-supervised interpretable
framework, which employs a self-supervised interpretable network (SSINet) to discover and locate fine-grained
causal features that constitute most evidence for the agent’s decisions. We verify and evaluate our method on
several Atari 2600 games as well as Duckietown. The results show that our method renders causal explanations
...
Arena extends the OpenAI Gym interface to allow greater flexibility in learning control policies across multiple
...
NVIDIA DGX-1 to learn successful strategies in Atari games in single-digit minutes, using both synchronous
...
families: deep Q-learning, policy gradients, and Q-value policy gradients. These have developed along separate
lines of research, such that few, if any, code bases incorporate all three kinds. Yet these algorithms share a great
...
with detailed implementation and usage notes. rlpyt is available athttps://github.com/astooke/rlpyt.
...
ment Learning for Trade Execution.” In: _arXiv e-Print_.


Advances in Reinforcement Learning (RL) span a wide variety of applications which motivate development
...
Multi-Goal Exploration.” In: _arXiv e-Print_.
...
all the goal states that are reachable withinLsteps in expectation from a reference states 0 in a reward-free
Markov decision process. In the tabular case withSstates andAactions, our algorithm requiresO ̃(L^3 SA−^2 )
...
In: _Knowledge-Based Systems_ 209, p. 106454.
...
Testing of Complex Portfolios.” In: _Risk (Cutting Edge)_.
...
simulation study. We found that changing significance thresholds had little effect on conclusions. Furthermore,
...
Pericchi and Pereira (2016) promote the use of fluctuating alpha levels as a function of sample size to assist
...
inforcement Learning.” In: _arXiv e-Print_.
...
data-driven investment robo-advising framework, consisting of two ML agents. The first agent, an inverse
...
dilemma. Finally, to maximally facilitate future research on MBRL, we open-source our benchmark inhttp:
...
algorithms and 9/13 Mujoco tasks with state-of-the-art performance. We open-sourced Tianshou athttps:


//github.com/thu-ml/tianshou, which has received over 3k stars and become one of the most popular
PyTorch-based DRL libraries.
Wiecki, T., Campbell, A., Lent, J., and Stauth, J. (2016).“All That Glitters Is Not Gold: Comparing Backtest
and Out-of-Sample Performance on a Large Cohort of Trading Algorithms.” In: _The Journal of Investing_
25(3), pp. 69–80.
...
Approach for Stock Trading.” In: _arXiv e-Print_.
...
e-Print_.
Reinforcement learning (RL) has gained increasing attraction in the academia and tech industry with launches
...
proposes a heuristic-based feature analysis method to validate whether an MDP is well formulated. We believe
...
problem formulation is a novel direction. We envision that our tool will serve as a motivational example to
...
Trading: An Ensemble Strategy.” In: _SSRN e-Print_.
...
solutions. We first identify several key challenges to achieve efficient exploration, which most of the exploration
methods aim at addressing. Then we provide a systematic survey of existing approaches by classifying them
into two major categories: uncertainty-oriented exploration and intrinsic motivation-oriented exploration. The
...
model-free RL agents used in prior work. The noisy and non-stationary behaviour of daily asset prices in the
...
the 1/N rule is optimal in a one-factor model with diversifiable risks as dimensionality increases, irrespectively
...
“On the Importance of Hyperparameter Optimization for Model-based Reinforcement Learning.” In: _arXiv
e-Print_.
Model-based Reinforcement Learning (MBRL) is a promising framework for learning control in a data-efficient
...
compared to using static hyperparameters which are kept fixed for the whole training. Finally, our experiments
...
computing devices, researchers are able to attack many challenging RL problems. However, in machine
learning, more training power comes with a potential risk of more overfitting. As deep RL techniques are being
...
Based on Sample Reweighting and Feature Selection for Financial Data Analysis.” In: _IEEE International
Conference on Data Mining (ICDM)_. IEEE.
...
ing firms have been producing an increasing number of features (aka factors). Therefore, how to automatically
...
Zhang, H. and Yu, T. (2020).“Taxonomy of Reinforcement Learning Algorithms.” In: _Deep Reinforcement
Learning_. Springer Singapore, pp. 125–133.
...
model obtains the best performance over the testing period of 2011 to the end of April 2020, including the
...
Learning Based Recommendations via Multi-goals Abstraction.” In: _arXiv e-Print_.
