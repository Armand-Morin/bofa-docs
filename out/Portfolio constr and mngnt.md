...
3\.1 Interaction with students . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 21
3\.2 Data . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 21
...
7\.5 Causality, inference and dependencies . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 39
...
7\.37 Statistics and Probability . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 94
...
13Stagnol (“The Risk Parity Principle Applied to a Corporate Bond Index,” 2017\)
...
16Zolotareva (“Aiding Long\-Term Investment Decisions with XGBoost Machine Learning Model,” 2021\)
...
40•LightGBM: fast, distributed, high performance gradient boosting (GBT, GBDT, GBRT, GBM or MART)
...
41•mixSPE: Mixtures of Power Exponential and Skew Power Exponential Distributions for Use in Model\-Based
...
42•genieclust: Fast and Robust Hierarchical Clustering with Noise Point Detection
...
43•evclust: Evidential Clustering
...
44•pytorch\_cluster: PyTorch Extension Library of Optimized Graph Cluster Algorithms
...
45•flake8: glues together pycodestyle, pyflakes, mccabe, and third\-party plugins to check the style and quality of
code
...
46•pydantic: Data parsing and validation using Python type hints
...
48•rstudio.prefs: Set ’RStudio’ Preferences
...
•py\-spy: Sampling profiler for Python programs
49•scalene: high\-performance, high\-precision CPU, GPU, and memory profiler for Python
...
•generalCorr: Generalized Correlations, Causal Paths and Portfolio Selection
•mashr: Multivariate Adaptive Shrinkage
51•MatrixCorrelation: Matrix Correlation Coefficients
...
53•rigr: Regression, Inference, and General Data Analysis Tools in R
...
54•pythae: Unifying Generative Autoencoder implementations in Python
...
55•MSCMT: Multivariate Synthetic Control Method Using Time Series
...
56•Voluptuous: data validation library.
...
587\.16 Data regimes, states and changepoints: analysis and modeling
Collections of resources
List of links:
...
60•robcp: Robust Change\-Point Tests
...
hierarchical data
61•PyMongo \- the Python driver for MongoDB
...
•motifcluster: Motif\-Based Spectral Clustering of Weighted Directed Networks
62•qs: Quick Serialization of R Objects
...
637\.19 Dimensionality reduction
Python
...
64•Rdimtools: Dimension Reduction and Estimation Methods
...
•Stone\-Soup: framework for the development and testing of tracking algorithms
65•stumpy: variety of time series data mining tasks
•tidydr: Unify Dimensionality Reduction Results
...
67•pdp: Partial Dependence Plots
...
68•theft: Tools for Handling Extraction of Features from Time Series
...
•praznik: Tools for Information\-Based Feature Selection and Scoring
69•psd: Adaptive, Sine\-Multitaper Power Spectral Density and Cross Spectrum Estimation
...
70•glum: Generalized linear models
...
•scikit\-learn: machine learning in Python
71•sktime: unified framework for machine learning with time series by UK national institute for data science and
artificial intelligence
...
•ForeCA: Forecastable Component Analysis
72•ForecastComb: Forecast Combination Methods
...
73•robets: Forecasting Time Series with Robust Exponential Smoothing
...
•yardstick: Tidy Characterizations of Model Performance
•yhat: Interpreting Regression Effects
747\.26 Graphs and graphical modeling
Python software implementations
List of packages and/or codes and/or frameworks and/or links:
...
76•Catalyst: PyTorch framework for Deep Learning Research and Development
•catboost: Gradient Boosting on Decision Trees by Yandex
...
77•NannyM: estimate post\-deployment model performance (without access to targets), detect data drift, and
...
78•distillML: Model Distillation and Interpretability Methods for Machine Learning Models
...
797\.29 Machine Learning frameworks (includes Automated ML and hyperparameters
tuning)
Python software implementations
List of packages and/or codes and/or frameworks and/or links:
...
80•Optuna: hyperparameter optimization framework
•PyCaret : machine learning library
...
•karateclub: Framework for Unsupervised Learning on Graphs
81•netrd: etwork {reconstruction, distances, dynamics}
...
82•statnet: Software Tools for the Statistical Analysis of Network Data
...
83•nlopt: nonlinear optimization
...
84•graDiEnt: derivative\-free, optim\-style Stochastic Quasi\-Gradient Differential Evolution optimization
...
•GPyTorch: Gaussian processes for modern machine learning systems.
•MAPIE: scikit\-learn\-compatible module for estimating prediction intervals
85•NGBoost: Natural Gradient Boosting for Probabilistic Prediction
...
86•hmmr: ”Mixture and Hidden Markov Models with R” Datasets and Example Code
...
87•RMixtComp: Mixture Models with Heterogeneous and (Partially) Missing Data
...
88•Gym: ttolkit by openAI for toolkit for developing and comparing reinforcement learning algorithms
...
90•RobustANOVA: Robust One\-Way ANOVA Tests under Heteroscedasticity and Nonnormality
...
92•NonpModelCheck: Model Checking and Variable Selection in Nonparametric Regression
•pcaPP: Robust PCA by Projection Pursuit
...
937\.36 Sensitivity analysis and numerical derivatives
Python software implementations
List of packages and/or codes and/or frameworks and/or links:
•derivative: Numerical differentiation of noisy time series data
...
94•PyProbables: Probabilistic data structures in python
...
95•mlquantify: Algorithms for Class Distribution Estimation
...
•evmix: Extreme Value Mixture Modelling, Threshold Estimation and Boundary Corrected Kernel Density
Estimation
96•ExtremalDep: Extremal Dependence Models
...
•slearn: package linking symbolic representation with scikit\-learn machine learning
97•SR Bench: benchmark framework for symbolic regression
...
Dimensional Data
•fbst: The Full Bayesian Evidence Test, Full Bayesian Significance Test and the e\-Value
99•fdrci: Permutation\-Based FDR Point and Confidence Interval Estimation
...
100•OutliersO3: Draws Overview of Outliers (O3\) Plots
...
•walrus: Robust Statistical Methods
•yardstick: Tidy Characterizations of Model Performance
1017\.41 Testing software codes
Python software implementations
List of packages and/or codes and/or frameworks and/or links:
...
103•hcrystalball: unifies the API for most commonly used libraries and modeling techniques for time\-series fore\-
...
105•shrink: Global, Parameterwise and Joint Shrinkage Factor Estimation
•simts: Time Series Analysis Tools
•SLBDD: Statistical Learning for Big Dependent Data
...
106•nlpaug: Data augmentation for NLP
...
107•text2sdg: Detecting UN Sustainable Development Goals in Text
...
List of packages and/or codes and/or frameworks and/or links:
•bootComb: Combine Parameter Estimates via Parametric Bootstrap
1087\.45 Visualization and reporting
Python software implementations
List of packages and/or codes and/or frameworks and/or links:
•Algviz is an algorithm visualization tool for your Python code
...
•torchsde: Differentiable SDE solvers with GPU support and efficient sensitivity analysis
109•tourr: Tour Methods for Multivariate Data Visualisation
...
•ggESDA: Exploratory Symbolic Data Analysis with ’ggplot2’
110•ggfocus: Scales that Focus Specific Levels in your ggplot
...
111•gtsummary: Presentation\-Ready Data Summary and Analytic Result Tables
•heatmaply: Interactive Cluster Heat Maps Using ’plotly’ and ’ggplot2’
•heplots: Visualizing Hypothesis Tests in Multivariate Linear Models
...
112•shinydlplot: Add a Download Button to a ’shiny’ Plot or ’plotly’
...
1138\.2 Research studies with code
...
114Snow (“Machine Learning in Asset Management Part 1: Portfolio Construction Trading Strategies,” 2020\)
Snow (“Machine Learning in Asset Management \- Part 2: Portfolio Construction \- Weight Optimization,” 2020\)
...
115•lrsm\_portfolio: Portfolio Construction using Stratified Models
...
1168\.4 R software implementations
List of packages and/or codes and/or frameworks and/or links:
•ASSA: Applied Singular Spectrum Analysis
...
•qlcal: R Bindings to the Calendaring Functionality of ’QuantLib’
117•qrmtools: Tools for Quantitative Risk Management
...
Alonso, N. and Qian, E. (2013\). “Risk Parity Equity Strategy with Flexible Risk Targets .” In:The Journal of
...
pp. 74–88\.
119Avella\-Medina, M. (2020\). “Robust Methods for High\-Dimensional Regression and Covariance Matrix Estimation .”
...
pp. 112896\+.
Bardakci, I. E. and Lagoa, C. M. (2019\). “Distributionally Robust Portfolio Optimization .” In:IEEE 58th Conference
...
120Benhamou, E., Saltiel, D., Ungari, S., and Mukhopadhyay, A. (2021e). “Bridging the Gap Between Markowitz
...
approach to portfolio selection via weighted clique relaxations .” In:Annals of Operations Research 216(1\), pp. 23–
34\.
...
Print.
121Bongiorno, C. and Challet, D. (2020b). “Reactive Global Minimum Variance Portfolios with k\-BAHC covariance
...
SSRN e\-Print .
122Cesarone, F. and Tardella, F. (2017\). “Equal Risk Bounding is better than Risk Parity for portfolio selection .” In:
...
341 pp.
Coqueret, G. and Milhau, V. (2014\). “Estimating Covariance Matrices for Portfolio Optimisation .” In:SSRN e\-Print .
...
123Costa, G. and Kwon, R. H. (2020c). “A regime\-switching factor model for mean\-variance optimization .” In:Journal
...
57(3\), pp. 560–577\.
124DeMiguel, V., Utrera, A. M., and Uppal, R. (2021\). “Crowding and Liquidity Provision in Factor Investing .” In:
SSRN e\-Print .
...
e\-Print .
du Plessis, H. and van Rensburg, P. (2020\). “Risk\-based portfolio sensitivity to covariance estimation .” In:Investment
...
125Fabozzi, F. J., Kolm, P. N., Pachamanova, D. A., and Focardi, S. M. (2012\). “Robust Portfolio: Optimization
...
126Gotoh, J.\-y., Kim, M. J., and Lim, A. E. B. (2018\). “Robust empirical optimization is almost the same as mean\-
...
127Hight, G. N. and Haley, J. D. (2021\). “Low\-Risk Benchmarking Transcends Rebalancing Methods .” In:The Journal
...
Iori, G. and Mantegna, R. N. (2018\). “Empirical analyses of networks in finance .” In:Handbook of Computational
...
Jacobsen, B. and Lee, W. (2020\). “Risk Parity Optimality Even with Negative Sharpe Ratio Assets .” In:The Journal
of Portfolio Management 46(6\), pp. 110–119\.
128Jaconetti, C. M., DiJoseph, M. A., Jr., F. M. K., Pakula, D., and Lobel, H. (2020\). From assets to income: A
...
129Khang, K. and Picca, A. (2021\). “Waiting for the Next Factor Wave: Daily Rebalancing around Market Cycle
Transitions .” In:The Journal of Portfolio Management 47(2\), pp. 127–144\.
Kim, H. and Kim, S. (2021\). “Reduction of estimation error impact in the risk parity strategies .” In:Quantitative
Finance .
...
returns are a mixture of normals .” In:Omega 91 (102008\).
...
130Lassance, N. and Vrins, F. (2021\). “Portfolio selection with parsimonious higher comoments estimation .” In:Journal
...
131Liszewski, O. (2016\). “Asset allocation under multiple regimes .” MA thesis. Erasmus University.
...
Maeso, J.\-M. and Martellini, L. (2020\). “Measuring portfolio rebalancing benefits in equity markets .” In:The Journal
...
132F. Critchley, and C. T. J. Dodson. Signals and Communication Technology. Springer International Publishing,
pp. 149–174\.
...
133Munro, B. and Bradfield, D. (2016\). “Putting the squeeze on the sample covariance matrix for portfolio construction .”
...
Paolella, M. (2017\). “The Univariate Collapsing Method for Portfolio Optimization .” In:Econometrics 5(2\), pp. 18\+.
...
134Pawar, A. and Rathi, A. (2021\). “An Ensemble Approach to Portfolio Optimization .” In:SSRN e\-Print .
Pedersen, L. H., Babu, A., and Levine, A. (2020\). “Enhanced Portfolio Optimization .” In:SSRN e\-Print .
Pedersen, L. H., Babu, A., and Levine, A. (2021\). “Enhanced Portfolio Optimization .” In:Financial Analysts Journal
77(2\), pp. 14–151\.
...
ment 48(3\), pp. 59–72\.
135Rudin, A., Mor, V., and Farley, D. (2020\). “Adaptive optimal risk budgeting .” In:The Journal of Portfolio Man\-
...
136Simaan, M., Simaan, Y., and Tang, Y. (2018\). “Estimation error in mean returns and the mean\-variance efficient
...
137Tatsat, H., Puri, S., and Lookabaugh, B. (2020\). Machine Learning and Data Science Blueprints for Finance: From
...
Toma, A. and Leoni\-Aubin, S. (2015\). “Robust Portfolio Optimization Using Pseudodistances .” In:PLoS ONE
10(10\), e0140546\+.
...
138Vincent, K., Hsu, Y.\-C., and Lin, H.\-W. (2018\). “Analyzing the Performance of Multifactor Investment Strategies
...
e\-Print .
139Zaimovic, A., Omanovic, A., and Arnaut\-Berilo, A. (2021\). “How Many Stocks Are Sufficient for Equity Portfolio
Diversification? A Review of the Literature .” In:Journal of Risk and Financial Management 14(11\), p. 551\.
Zakamulin, V. (2015\). “A Test of Covariance\-Matrix Forecasting Methods .” In:TheJournalofPortfolioManagement
41(3\), pp. 97–108\.
...
19(7\), pp. 1097–1120\.
140Appendix A: Overviews of investment processes and models in QWIM
References
List of references:
Coqueret and Guida ( Machine Learning for Factor Investing: R Version , 2020\)
Dixon et al. ( Machine Learning in Finance: from theory to practice , 2020\)
...
141Appendix C: Incorporating comparison of portfolio metrics using bench\-
mark portfolios
...
142Python and R packages/codes for portfolio optimization
...
143Python and R packages/codes for portfolio metrics and performance evaluation
•bt
•empyrical
•ffn
•JFE
...
144•expected covariance matrix is calculated based on forecasted values available at June 20, 2019 and obtained
using the forecasted model trained on given training dataset (which is from 1990 to 2017\)
