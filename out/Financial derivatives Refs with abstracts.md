# References with abstracts forQWIMproject: Financial Derivatives in
...
Israelov and Tummala (“Being Right Is Not Enough: Buying Options to Bet on Higher Realized Volatility,”
2020)
...
Bhansali ( _Tail risk hedging: Creating Robust Portfolios for Volatile Markets_ , 2014)
...
Farahani and Yan ( _Constructing a Liability Hedging Portfolio: A Guide to Best Practices for US Pension Plans_ ,
2014)
Flint et al. (“In Search of the Perfect Hedge Underlying,” 2016)
...
```
Walther (“Probabilities of Future Equity Returns,” 2020)
```
...
Volatility Curves.” In: _SSRN e-Print_.
...
Returns on delta-neutral straddles around EADs are significantly lower in the presence of concave IV curves,
showing that investors pay a high premium to hedge against this event risk.
Alexiou, L. and Rompolis, L. S. (2022).“Option-implied moments and the cross-section of stock returns.” In: _Journal
of Futures Markets_ 42(4), pp. 669–691.
...
An, b.-J., Ang, A., Bali, T. G., and Cakici, N. (2014).“The Joint Cross Section of Stocks and Options.” In: _The
Journal of Finance_ 69(5), pp. 2279–2337.
...
market.” In: _Journal of Econometrics_ 222(1(Part B)), pp. 344–363.
...
through the identical mechanism as for other equity market indices, suggesting a high degree of global integration
...
vestors.” In: _Journal of Asset Management_ 9(5), pp. 310–320.
...
Appel, V. van and Mare, E. (2019a).“The recovery theorem with application to risk management.” In: _SSRN
e-Print_.
...
world distribution. Furthermore, an empirical study, using weekly South African Top40 option trade data, is
...
a prediction device.” In: _Journal of Financial Econometrics_ 19(2), pp. 291–312.
...
bound alone.
Backwell, A. (2015).“State Prices and Implementation of the Recovery Theorem.” In: _Journal of Risk and Financial
Management_ 8(1), pp. 2–16.
It is generally held that derivative prices do not contain useful predictive information, that is, information relating
...
allocation model.” In: _Malaysian Journal of Fundamental and Applied Sciences_ 16(1), pp. 64–69.
...
Dow Jones Industrial Average (DJIA) index options and its constituents. The data covers the period from January
...
portfolio. The empirical evidence shows that for a portfolio based on an option-implied distribution, the volatility
...
Bakshi, G. S., Crosby, J., and Gao, X. (2021).“Ambiguity and Blowups.” In: _SSRN e-Print_.
...
Returns?” In: _Journal of Financial and Quantitative Analysis_ 48(04), pp. 1145–1171.
...
market factors.
Barker, R. C., Dickinson, A. S., and Lipton, A. (2016).“Simulation in the Real World.” In: _SSRN e-Print_.
...
option data.” In: _Quantitative Finance_ 16(7), pp. 1147–1164.
...
dynamic portfolio strategies.” In: _Computational Management Science_ 16(3), pp. 433–479.
...
the US, portfolio strategies based on combinations of market indices and derivatives have been proposed by
...
tell us.” In: _Journal of Pension Economics and Finance_ 14(03), pp. 240–265.
...
Bevilacqua, M. and Tunaru, R. (2021).“The SKEW index: Extracting what has been left.” In: _Journal of Financial
Stability_ 53, p. 100816.


This study disentangles a measure of implied skewness that is related to downward movements in the U.S. equity
...
Bhansali, V. (2014). _Tail risk hedging: Creating Robust Portfolios for Volatile Markets_. McGraw-Hill. 272 pp.
...
Bhansali, V. (2008).“Tail Risk Management.” In: _The Journal of Portfolio Management_ 34(4), pp. 68–75.
In the current deleveraging episode, the severity and simultaneous realization of low-probability events across a
number of strategies has brought portfolio tail-risk hedging to the center of investors’ attention. In this article, the
...
Bhansali, V. (2018).“Right Tail Hedging: Managing Risk When Markets Melt Up.” In: _The Journal of Portfolio
Management_.
...
environment of low yields, elevated asset prices, low credit spreads, indexation, and multidecadal lows in call
option prices.
Bhansali, V., Chang, L., Holdom, J., and Rappaport, M. (2020).“Monetization Matters: Active Tail Risk Manage-
ment and the Great Virus Crisis.” In: _The Journal of Portfolio Management_ 47(1), pp. 16–28.
The authors discuss monetization strategies for both left- and right-tail risk hedging to illustrate the potential
benefits of active management of hedges. In particular, by including actual data from the sharp COVID-
...
Bondarenko, O. and Bernard, C. (2021).“Option-Implied Dependence and Correlation Risk Premium.” In: _SSRN
e-Print_.
...
Bormetti, G., Cocco, F., and Rossi, P. (2021).“Deep learning profit and loss.” In: _Risk (Cutting Edge)_.
...
fashion. They resort to a variation of the least squares Monte Carlo algorithm in which the continuation value of
the portfolio is interpolated with a feed-forward neural network. They account for the profit and loss distribution
of a whole portfolio even when the dependence structure between different assets is very strong, eg, for contingent
...
Cabej, G., Gilli, M., and Schumann, E. (2014).“Better portfolios with options.” In: _IEEE Conference on Compu-
tational Intelligence for Financial Engineering and Economics (CIFEr)_. London, UK: IEEE, pp. 107–113.
In the period following the last financial crisis, equity markets have performed poorly. In consequence, equity
long-only strategies have generally disappointed over this period. This has motivated the investigation on whether
better performance can be achieved by including equity options in the portfolios. We show that simple systematic
...
A similar setup as in Coleman et al. (2007) is considered with the risk management of lookback options embedded
...
Carr, P., Wu, L., and Zhang, Z. (2020). “Using Machine Learning to Predict Realized Variance.” In: _Journal Of
Investment Management_ 18(2).
...
Chabi-Yo, F. (2019).“What Is the Conditional Autocorrelation on the Stock Market?” In: _SSRN e-Print_.


We derive lower and upper bounds on the conditional market autocorrelation index at various investment
...
Chan, J. R., Huckle, T., Jacquier, A., and Muguruza, A. (2021).“Portfolio optimisation with options.” In: _arXiv
e-Print_.
...
of Stock Returns.” In: _Journal of Financial and Quantitative Analysis_ 56(5), pp. 1713–1737.
...
Chow, V., Gu, J., and Wang, Z. (2021).“Implied Equity Premium and Market Beta.” In: _SSRN e-Print_.
...
Empirically, the implied betas possess significant predictability of risk/return relationship and the hedging
...
Christoffersen, P. and Pan, X. N. (2014).“Equity Portfolio Management Using Option Price Information.” In: _SSRN
e-Print_.
...
you think.” In: _Journal of Asset Management_.
...
In: _The Journal of Wealth Management_ 8(2), pp. 36–41.
...
_Journal of Financial Economics_ 140(2), pp. 412–435.
...
historical schemes.” In: _Journal of Forecasting_ 37(5), pp. 589–603.
...
options.” In: _International Transactions in Operational Research_ 23(3), pp. 593–622.


We develop a multistage portfolio optimization model that utilizes options for mitigating market risk in a dy-
...
In: _Journal of Financial Economics_ 142(1), pp. 23–45.
We study the pricing of shocks to uncertainty and volatility using a wide-ranging set of options contracts covering
...
Diaz, M. and Kwon, R. H. (2019).“Portfolio optimization with covered calls.” In: _Journal of Asset Management_ 20,
pp. 38–53.
...
return.
Dillschneider, Y. (2021).“Generalized Transform Analysis for Asset Pricing and Parameter Estimation.” In: _SSRN
e-Print_.
In this paper, we extend the existing generalized transform analysis in a way that allows us to propose a novel
GMM approach for estimating asset pricing models. Our methodology is capable of incorporating a broad class of
...
equity options.
Dillschneider, Y. and Maurer, R. (2017).“Functional Ross Recovery: An Operator Approach.” In: _SSRN e-Print_.
...
matrix theory when the pricing kernel is transition independent. In this paper, we generalize the recovery theorem
...
_Journal of Economic Dynamics and Control_ 108, p. 103750.
...
Fan, Z., Londono, J. M., and Xiao, X. (2022a).“Equity tail risk and currency risk premiums.” In: _Journal of
Financial Economics_ 143(1), pp. 484–503.
...
Fan, Z., Xiao, X., and Zhou, H. (2022b).“Moment Risk Premia and Stock Return Predictability.” In: _Journal of
Financial and Quantitative Analysis_ 5757(11), pp. 67-9367–93.
...
horizons with negative (positive) coefficients. Combining the higher-moment risk premia with the second-moment
...
Farahani, A. and Yan, M. (2014). _Constructing a Liability Hedging Portfolio: A Guide to Best Practices for US
Pension Plans_. Tech. rep. Cambridge Associates.
To construct an effective liability hedging portfolio, a key first step is to evaluate the variety of ways liabilities can
...
majority of its liability hedging assets devoted to bond managers (typically with moderate tracking error) will not
...
was no improvement to performance when option-implied correlation was added to the optimization process,
...
the Ross Recovery Theorem.” In: _SSRN e-Print_.
...
surfaces. The issue of calibration with sparse and noisy data is considered at length and a simple but robust fitting
algorithm is proposed. Furthermore, we attempt to extract real-world implied information by implementing the
recovery theorem introduced by Ross (2015). Recovery is an ill-posed problem that requires careful consideration.
...
Flint, E. J., Seymour, A. J., and Chikurunhe, F. (2016a).“In Search of the Perfect Hedge Underlying.” In: _SSRN
e-Print_.
...
practically is that quantitative portfolio managers are regularly faced with problems spanning the entire P - Q
...
Return Predictability.” In: _The Journal of Derivatives_ 24(1), pp. 58–78.
...
return predictors.
Fusari, N., Jarrow, R., and Lamichhane, S. (2020).“Testing for Asset Price Bubbles using Options Data.” In: _SSRN
e-Print_.
...
Option-implied Risk Measures.” In: _SSRN e-Print_.
...
distributions.” In: _Quantitative Finance_.
The Ross recovery theorem shows that option data can reveal the market’s true (physical) expectations. We
adapt this approach to international index options data (S&P, FTSE, CAC, SMI, and DAX) to improve volatility
...
In: _The Journal of Index Investing_ 8(1), pp. 37–46.


The volatility risk premium (VRP), commonly accessed by writing equity index options, can help investors
...
ments.” In: _The Journal of Alternative Investments_ 20(4), pp. 69–80.
Hedge funds should deliver good risk-adjusted returns and provide diversification for investors portfolios. How-
ever, the performance of hedge funds has deteriorated in recent years and many investors may not find investment
...
Ge, W. (2019).“Using the volatility risk premium to mitigate the next financial crisis.” In: _The Journal of Wealth
Management_ 22(3), pp. 85–97.
...
market is overvalued and if a recession is on the way. It is usually impossible to predict the next financial crisis. An
...
Asset Management: A Review.” In: _Handbook of quantitative asset management_. Ed. by B. Scherer and K.
...
Golez, B. and Goyenko, R. (2022).“Disagreement in the Equity Options Market and Stock Returns.” In: _The Review
of Financial Studies_. 35th ser. 3, pp. 1433–1479.
...
returns after negative earnings surprises. The negative effect is stronger for high-beta stocks and stocks that are
...
Data and Machine Learning.” In: _SSRN e-Print_.
...
_The Journal of Derivatives_ 29(3), pp. 13–38.
...
for the worst of times: can portfolios be crisis proofed?” In: _The Journal of Portfolio Management_ 45(5), pp. 7–
28.
...
that performed well during past drawdowns include futures time-series momentum (which benefits from extended
...
implied variables.” In: _The European Journal of Finance_ 25(10), pp. 937–965.
We comprehensively analyze the predictive power of several option-implied variables for monthly S&P 500 excess
returns and realized variance. The correlation risk premium (CRP) and the variance risk premium (VRP) emerge
...
Horvath, F. (2021).“Arbitrage-Based Recovery.” In: _SSRN e-Print_.
...
Huggenberger, M., Zhang, C., and Zhou, T. (2018).“Forward-Looking Tail Risk Measures.” In: _SSRN e-Print_.
...
Israelov, R. (2019).“Pathetic protection: the elusive benefits of protective puts.” In: _The Journal of Alternative
Investments_.
Conventional wisdom is that put options are effective drawdown protection tools. Unfortunately, in the typical use
...
return.
Israelov, R. and Nielsen, L. N. (2015).“Still not cheap: portfolio protection in calm markets.” In: _SSRN e-Print_.
...
expensive on average, but what about in calm markets? History suggests it still is. We investigate the relationship
...
Volatility.” In: _The Journal of Alternative Investments_ 23(2), pp. 16–34.
...
Al-Jaaf, A. (2022).“Dividend predictability and higher moment risk premia.” In: _Journal of Asset Management_ 28,
pp. 83–99.
...
Jackwerth, J. C. and Menner, M. (2020).“Does the Ross recovery theorem work empirically?” In: _Journal of
Financial Economics_ 137(3), pp. 723–739.
...
Jensen, C. S. (2021).“The Ex Ante Physical Distributions of Individual Stock Returns.” In: _SSRN e-Print_.
...
_Journal of Banking & Finance_ 123, p. 106037.
...
instruments.” In: _British Actuarial Journal_ 19, pp. 468–498.
...
and papers on this specific issue. Just as diversification across conventional asset classes has decreased there
...
Kackar, S. and Rogal, K. (2022).“Application of Credit Derivatives In Portfolio Management.” In: _The Journal of
Derivatives_ 29(3), pp. 81–96.
...
_Review of Finance_ 19(1), pp. 467–490.
...
_Journal of the Operations Research Society of Japan_ 62(2), pp. 83–107.
...
is suitable for many financial problems such as market risk management and portfolio optimization due to its
...
tion.” In: _Journal of Futures Markets_ 41(2), pp. 266–285.
...
Le, T. H., Kourtis, A., and Markellos, R. N. (2021).“Modeling Skewness in Portfolio Choice.” In: _SSRN e-Print_.
...
Leung, T. and Ward, B. (2018).“Dynamic index tracking and risk exposure control using derivatives.” In: _Applied
Mathematical Finance_ 25(2), pp. 180–212.


We develop a methodology for index tracking and risk exposure control using financial derivatives. Under a
...
Liao, W. J. and Sung, H.-C. (2021).“Implied risk aversion and pricing kernel in the FTSE 100 index.” In: _The
North American Journal of Economics and Finance_ (100826).
...
interpolation method and the positive convolution approximation (PCA) method. The actual density distribution
...
literature, a considerable number of variables present strong in- and out of- sample performances, being one
...
cost.
Marks, J. M. and Simon, D. P. (2017).“Sector option implied volatility dynamics and predictability.” In: _Journal
of Derivatives_ 25(2), pp. 22–42.
...
speed of adjustmen...
Martin, I. (2021).“On the Autocorrelation of the Stock Market.” In: _Journal of Financial Econometrics_ 19(1),
pp. 39–52.
...
Ross Recovery from High Frequency Option Prices.” In: _SSRN e-Print_.
...
McQuinn, N., Thapar, A., and Villalon, D. (2021).“Portfolio Protection? It’s a Long (Term) Story ...” In: _The
Journal of Portfolio Management_ 47(3), pp. 35–50.
...
Milevsky, M. A. (2020).“Modeling the Risk of Sequence-of-Returns.” In: _Retirement Income Recipes in R_. Springer
...
sequence-of-returns.
Miller, M., Jacobsen, B., and Vree, M. de (2022).“Income Enhancement with Options.” In: _The Journal of Deriva-
tives_ 29(3).
...
Nardi, F. (2015).“Option Implied Moments (Mean-Variance?) of the Ex-Ante Return Distribution.” In: _SSRN
e-Print_.
...
Lastly, I also find that the forward looking Sharpe ratio has forecasting power; this finding can be adopted as a
...
In: _Journal of Asset Management_ 22(4), pp. 277–290.
...
optional strategies could offer better risk-return profiles than hedge funds. This paper proposes a synthetic equity
...
Ntantanis, H. and Pohlman, L. (2020).“Market implied GDP.” In: _Journal of Asset Management_ 21, pp. 636–646.
...
Park, H. (2016).“Ross recovery with recurrent and transient processes.” In: _Quantitative Finance_ 16(5), pp. 667–
676.
...
Factorization, Ross Recovery, and Long-Term Pricing.” In: _Operations Research_ 64(1), pp. 99–117.
...
model is specified by given risk-neutral probabilities together with a short rate function of the Markovian state,
...
Quaedvlieg, R. and Schotman, P. (2022).“Hedging Long-Term Liabilities.” In: _Journal of Financial Econometrics_.
...
Ross, S. (2015).“The Recovery Theorem.” In: _The Journal of Finance_ 70(2), pp. 615–648.
...
Sanford, A. (2022).“Optimized portfolio using a forward-looking expected tail loss.” In: _Finance Research Letters_
46(Part B) (102421).
...
Schneider, P. and Trojani, F. (2015).“(Almost) Model-Free Recovery.” In: _SSRN e-Print_.
...
a second.
Schreindorfer, D. (2020).“Macroeconomic tail risks and asset prices.” In: _The Review of Financial Studies_ 33(8),
pp. 3541–3582.
...
Seck, B. and Elliott, R. J. (2021).“Regime Switching Entropic Risk Measures on Crude Oil Pricing.” In: _arXiv
e-Print_.
...
Smales, L. A. (2020).“News sentiment as an explanation for changes in the VIX futures basis.” In: _The Journal of
Investing_ , joi.2020.1.125.
...
Stein, H. J. (2014).“Joining Risks and Rewards.” In: _SSRN e-Print_.
...
Returns?” In: _Management Science_ 63(6), pp. 1814–1834.
...
Szado, E. (2019).“The portfolio diversification potential of long VIX futures and options strategies.” In: _SSRN
e-Print_.
...
Szado, E., Kazemi, H., and Schneeweis, T. (2018).“Option informed stock picking.” In: _The Journal of Alternative
Investments_ 21(1), pp. 48–66.
A wide range of research has suggested that informed trading in options markets may effectively signal subsequent
...
Tan, S. (2013).“The role of options in long horizon portfolio choice.” In: _The Journal of Derivatives_ 20(4), pp. 60–77.
...
to a stock index portfolio, riskless bonds but limited ability to borrow, and at-the-money calls and puts on the
...
forwards.” In: _Journal of Banking and Finance_ 35(12), pp. 3188–3201.
...
Trainor, W. J., Chhachhi, I., and Brown, C. L. (2019).“Leaping Black Swans.” In: _The Journal of Investing_.
...
rebalancing during the term of coverage and are flexible enough to suit investors with very different risk tolerances
...
Crisis.” In: _The Journal of Portfolio Management_ 30(4), pp. 244–253.
...
structured as follows: In chapter II, which is based on the working paper Walther and Ulrich (2019), we inspect the
...
these measures and some methods lead to systematic biases, especially for out-of-the-money Put options. To over-
...
non-parametric volatility surfaces by means of leave-one-out cross-validation. Based on 14 years of end-of-day and
intraday S&P 500 and Euro Stoxx 50 option data, we show that our methods represent option market information
more accurately than existing approaches of the literature. Having established accurate measurements for the


risk-neutral distribution, we next turn to the estimation of the physical distribution of equity returns in chapter
...
Xiao, X. and Zhou, C. (2014).“Option Implied Risk Measures: A Maximum Entropy Approach.” In: _SSRN e-Print_.
This paper investigates option implied risk measures (volatility, skewness and kurtosis) by applying the principle
of maximum entropy. Compared to parametric models, e.g. Black Scholes model, this method is free of parametric
...
macro-factors.” In: _Journal of the Operational Research Society_ , pp. 1–21.
...
GARCH and realized variance models. Contributing to this ongoing debate, we introduce the novel AIM-HEAVY
...
financial with macroeconomic uncertainties to explore the macro-financial linkages in the high-frequency domain.
...
outbreak. Financial volatilities are already close to their crisis-peaks amid the generalized fear about controversial
...
volatility scaling.
Zhu, S., Zhu, W., Pei, X., and Cui, X. (2020).“Hedging crash risk in optimal portfolio selection.” In: _Journal of
Banking & Finance_ 119, p. 105905.
