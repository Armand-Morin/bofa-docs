References with abstracts for QWIMproject: ESG, impact and
...
16Yu (“Comparing Classical Portfolio Optimization and Robust Portfolio Optimization on Black Swan Events,”
2021\)
...
uncertaintyandthenegativeESG\-alpharelationweakens.EmployingthestandarddeviationofESGratingsfrom
...
31Environmental, social, and governance (ESG) information demands attention within the asset management
...
32Bruni, R., Cesarone, F., Scozzari, A., and Tardella, F. (2017\). “On exact and approximate stochastic dominance
...
outperformanceofthesestrategiescanbeexplainedbytheirexposuretoequitystylefactorsthataremechanically
...
individuallyconstructedfactorportfolios,acompositebenchmarkoffactorportfolios,andastockselectionmodel
...
33bad companies and significant costs with the more aggressive ESG screening techniques. In general, the authors
...
returnsontheUS,apositiveimpactoftheSocialscoreontheUSandAsiaandapositiveimpactoftheESGscore
...
34stronger for firms that are closer to end\-consumers, facing severer product competition, with higher investors’
...
extensiveempiricalanalysisonfivedatasetsinvolvingreal\-worldcapitalmarketindicesfrommajorstockmarkets.
...
35are GAMs? ” In:Proceedings of the 27th ACM SIGKDD Conference on Knowledge Discovery \& Data Mining .
ACM.
...
We document that ES ratings haveno significantrelationship with average stockreturns or unconditional market
risk.StocksoffirmswithhigherESratingsdohavesignificantlylowersystematicdownsiderisk.Suchreductionin
...
36Chen, M., Mussalli, G., Amel\-Zadeh, A., and Weinberg, M. O. (2022\). “NLP for SDGs: Measuring Corporate
...
theinterestandthesurgeinassetsundermanagement(AUM)inflow,environment,social,andgovernance(ESG)
...
theirinvestmentprocess.Thisarticleoffersadifferentperspectiveontherelationshipbetweenqualityfactorsand
...
37relative to the US value\-weighted market portfolio, from overweighting stocks of high\-emission firms by 0\.5%
...
Performance .” In:Risks9(10\), p. 172\.
...
resultingappetiteforgreenassetsisimpactingthedecisionsofmanyinvestors.PerspectivesinSustainableEquity
...
38•Chapter 4, which is the core of the book, is dedicated to the very complex relationship between ESG
...
39factor it also points towards lower expected returns for investments in highly rated companies. Though ESG
...
40these explain the ESG Bloomberg ratings. We find that financial statements items represent a powerful tool to
...
stockswithlowcontroversyornocontroversyatall.Themainreasonforthisresultisthat,inbothcases,markets
...
41the ESG profile of a company, but that this alpha can be accessed only with powerful, non\-linear techniques
...
Dimson,E.,Marsh,P.,andStaunton,M.(2020\). “DivergentESGRatings .”In:TheJournalofPortfolioManagement
47(1\), pp. 75–87\.
...
42Drei, A., Le Guenedal, T., Lepetit, F., Mortier, V., Roncalli, T., and Sekine, T. (2019\). “ESG Investing in Recent
...
sectionofcorporatebondreturns.Contrarytothe”carbonriskpremium”hypothesis,wefindbondsoffirmswith
...
43academic journals so that referees, and ultimately readers, can assess the strategy. By disclosing this information,
...
committedstrategiesprovideuswithseveraleconomicandeconometricadvantages,allowingustodocumentthat
...
SociallyResponsibleinvestinghasbecomeakeypointofdiscussionwithinthepastfewyearsassocietygravitates
...
44In this article, the authors explain how asset owners and asset managers should behave to cope with new
...
emissionsthandoequityinvestorsbyaffectingfundingcosts.Thiscanbedonethroughcarbonemissionreduction
...
45measurement of the quality of the narrative part of the CARs, which is greatly enhanced by using two composite
...
methodtocalculateincrementalcreditlossesonaloanportfoliothatarerootedintophysicalandtransitionrisks.
...
by Green RWA https://www.greenrwa.org/ .
...
46factor models subsume neither environmental\-related return differentials nor expected return premia from those
...
firmsintheS\&P500Indexbetween2010and2017,westudiedtherelationshipbetweenESGratingdisagreement
and stock returns. We found that stock returns are positively related to ESG rating disagreement, suggesting a
riskpremiumforfirmswithhigherESGratingdisagreement.Therelationshipisprimarilydrivenbydisagreement
...
47benchmarks. They find that integrating ESG into benchmarks makes sense as a framework to achieve consistency
...
Giese,G.,Lee,L.\-E.,Melas,D.,Nagy,Z.,andNishikawa,L.(2019c). “PerformanceandRiskAnalysisofIndex\-Based
...
involvingdifferentcombinationsoffinancialand nonfinancialinputs. Determiningthe mostinfluentialcriteriafor
...
48can be used as a performance factor in a similar way is a controversial topic in the asset management community.
...
Investorsthroughouttheworldareincreasinglyinterestedinenvironmental,social,andgovernance(ESG)issues.
...
49believe that specific forms of ESG investing can be prudent for investors with particular preferences, beliefs,
...
performance.ThechoiceofaspecificESGmetricbeingcrucial,wefocusontheNetEnvironmentalContribution,
...
Incorporatingenvironmental,social,andgovernance(ESG)considerationsintosystematicinvestmentshasdrawn
...
50Gutterman, A. (2020\). “Impact Investment Tools, Structures and Instruments .” In:SSRN e\-Print .
...
instrument.
Gyonyorova,L.,Stachoň,M.,andStašek,D.(2022\). “ESGratings:relevantinformationormisleadingclue?Evidence
...
testingwhetherfinancialmarketsarepricingphysicalrisks.Hence,financialmarketsmaynotadequatelyaccount
...
51strong out\-of\-sample performance, in most cases superior to the equal\-weight naive strategy. These findings are
...
52sharing one investor perspective, this will prove useful for all investors as a data point for considering the role
...
Hays,M.andMcCabe,J.(2021\). “SustainableandImpactInvesting:ATaxonomyofApproachesandConsiderations
...
Wheninvestorscompareseveralsustainableinvestments,theirWTPincreaseswithimpact,butdependsstrongly
...
53performed in the past. The impact test considers the performance of the strategy when assets under management
...
54Hubel, B. and Scholz, H. (2020\). “Integrating sustainability risks in asset management: the role of ESG exposures
...
risksforfirms.WeconstructthreeESGriskfactors(Environmental,Social,andGovernance)toquantifytheESG
riskexposuresoffirms.Takingthesefactorsintoaccountsignificantlyenhancestheexplanatorypowerofstandard
...
Husse,T.andPippo,F.(2022\). “ResponsibleMinusIrresponsible\-adeterminantofequityriskpremia? ”In:Journal
...
toverifytheimpactoftheintegrationbetweenESGandsmartbetaanalysis,firstweapplyaportfoliorebalancing
...
55concepts detailed here, the reader will find useful references to other works to develop an in\-depth understanding
...
This article presentsan encompassing four\-step customizable frameworkfor analyzing the heterogeneous sustain\-
...
56characteristics and the statistical properties of the asset universe. We test this pipeline for studying risk\-parity
...
abroadmarketandanESGscreenedindex.Wesuggestthedouble\-indexmodelandextendeddecisioncriteriafor
...
e\-Print.
57Impact investing is based on using the ESG framework as a tool to evaluate firms that engage in generating
...
avoidancetoidentifyfirmsthataresociallyresponsible.Whenfirmsindulgeinexcessivetaxavoidancebehaviour,
...
approachandputitinperspectivetotraditionalweightingschemesconsideredbysustainableportfoliomanagers.
...
Kanuri,S.(2020\). “RiskandReturnCharacteristicsofEnvironmental,Social,andGovernance(ESG)EquityETFs .”
...
academicresearchhasmostlymixedreturnsinportfoliolevelstudiesontherelationshipofESGandperformance.
...
58To investigate risk\-adjusted returns of high and low ESG fund portfolios, the monthly returns of the portfolios
...
ESGimplicationduringmarketdownturnsdummyvariabledepicting10%oflowestmarketre\-turnsisintroduced
...
59strategies of the tests. For the applied researcher, we provide some guidance as to how to cope with the problem
...
alsoexhibitshighexcessreturns.Suchcompaniesalsocontemporaneouslyexhibithighreturnonassets.Portfolios
...
allowsinvestorstomaximizeimpactforacertainlevelofrisk\-adjustedreturns.Forexample,wefindthatinvestors
...
60specialized rating agencies that issue ratings along the environmental, social and governance (ESG) dimensions.
...
duetohumanlaborinvolved,ratingagenciesarecurrentlyfacingthechallengetoscaleupthecoverageinatimely
...
increasestherisk\-adjustedreturnoftheportfolio.Theauthorsalsoexaminetheeffectoftheseparatecomponents
...
61and the implementation should be well thought out. Alternative risk conceptions, such as regret risk, can be
...
alsoholdsafteraccountingforthecontributionofthestylefactorsidentifiedbytheFama\-Frenchfive\-factormodel
and the macroeconomic factors of the BIRR model. The novelty of the paper is threefold: a) the large array of
ESGmetricsanalysed,b)themodel\-freemethodologyensuredbyMLandc)thedisentanglingofthecontribution
...
62ESG score should proceed with caution. A naive approach such as equal weighting could introduce noise that
...
2\)Incontrast,ESGinvestingwasa sourceofoutperformancefrom2014to2017in EuropeandNorthAmerica,
...
researchprojectstartedatAmundiin2014ontherelevanceofESG.Sincethelatestupdatein2019,wehavelived
...
63Many investors are striving to incorporate granular ESG data into their decision\-making. The use of scores
...
strategiescancostnothing.ModifyingoptimalportfolioweightstoachieveanESG\-investingtiltnegligiblyaffects
...
isprovidedbyotherobservablefirmcharacteristics.Thatthestockmarketdoesnotreflectsignificantequilibrium
...
64hierarchical clustering based on the lower tail dependence coefficient. The chapter provides an overview of tradi\-
...
properlydisclosed,canbeusefulasitallowsinvestorstochoosewhatratingwillalignmorewiththeirpreferences,
...
65their alpha from static factor exposures, which reflects a tilt toward higher\-quality bonds that are less volatile.
...
such as machine learning.
Martin, S. M. (2021\). “Impact Investing. A Practitioner Perspective .” In:Studies of Applied Economics 39(3\).
...
66issues, the risk of Impact washing and the availability of Impact investments across various asset classes are
...
67risk exposures, risk management and governance standards and have better long\-term vision. The paper finds
...
68that can limit task performance are differences in word distribution between the general corpora \- typically used
...
onanEnvironmental,SocialandGovernance(ESG)controversiesdatasetanddemonstratethatbothapproaches
...
byriskindicatorssuchasVIX,CDS,andFXvolatilityindex.GermanyESG\-X,CDAX,FranceESG\-X,CACAll,
Indonesia SRI\-KEHATI, IDX Composite, BIST (Borsa Istanbul) Sustainability, and BIST All price indices have
beenexamined.ThedailydatabetweenNovember4,2014,andDecember5,2019areused.Vectorautoregression
...
ThisstudyinvestigatestheimpactofthechoiceofoptimizationtechniquewhenconstructingSociallyResponsible
...
risk\-returntrade\-offsthandomoresimplisticapproaches;althoughtheyalsohavemoreunstableassetallocations
...
69We consider whether sustainable investment can deliver performance comparable to conventional investment in
...
return.Combiningseverallargedatasets,wecomputetheempiricalESG\-efficientfrontierandshowthecostsand
...
70quantile dependence between green bonds and other assets. Our data set covers the U.S. and European asset
...
oftheseheterogeneousexpectations,thisarticlesetsouttoempiricallyinvestigatetheperformancecharacteristics
...
71of both sustainable and nonsustainable assets. In this study, mean\-variance spanning tests that are based on
...
withatemperaturetrajectory,orportfoliotemperaturealignment,arepresentlylackingandfewacademicstudies
...
72Using information on climate transition risks embedded in US equity mutual fund portfolios, we report evidence
...
734\.d. The challenge of reporting 5\. Tutorial exercises 5\.a. Probability distribution of an ESG score 5\.b. Enhanced
...
e\-Print.
74Environmental, Social, and Governance (ESG) scores measure companies’ performance concerning sustainability
andsocietalimpactandareorganizedonthreepillars:Environmental(E),Social(S),andGovernance(G).These
...
thesamedataprovidermightbeinconsistent.Byoptimizationandexploratorydata\-miningapproaches,weshow
...
faceincreasingpressuretorelyonESGfactorsintheinvestmentmanagementoftensoftrillionsofdollarsofother
...
bytrusteesandinvestmentfiduciariesispermissible.Wemakefourinterrelatedpoints:(1\)weprovideaclarifying
...
75and lower Sharpe ratios. Partial correlations based portfolios are more diversified and have higher PESGVs than
...
investorsneedtouseportfolioperformancemeasurethatisexplicitlysensitivetotheportfolioESGvalue.Second,
...
76views about the value of sustainability activities and that big ESG data can be useful in identifying value ESG
stocks.
...
inconsistentlysignificantabnormalreturnsof0\.5%permonth,downgradesaredetrimentaltostockperformance,
...
77and governance (ESG) research\-based strategies. This study examines real data on ESG and non\-ESG inte\-
...
Althoughinvestinginenvironment,social,andgovernance(ESG)\-drivenportfoliosisalreadyalargeandgrowing
...
78Statman, M. and Glushkov, D. (2016\). “Classifying and Measuring the Performance of Socially Responsible Mutual
...
Stotz, O. (2021\). “Expected and realized returns on stocks with high\- and low\-ESG exposure .” In:Journal of Asset
...
Sixcompetingvendorsratehowcompaniesperformalongenvironmental,socialandgovernance(ESG)standards.
...
canaccuratelyandconsistentlyidentifystocksthatmeettheircriteria.Butnewresearchshowsthatthosecriteria
...
79Funds with a socially responsible or environmental, social and governance (ESG) mandate may allow clients to
...
SisterfirmsreceivehigherratingswhenthecommonownershavelargerstakesintheESGrater.Notwithstanding
...
80portfolio optimization model. The test results from the proposed novel methodology show that clustering with
...
81results (Gigerenzer 2004; Ioannidis 2005; Simmons et al. 2011\). We agree with these concerns and believe that
...
Thesinstockanomalywherestocksbelongingto”sin”industriessuchasalcohol,tobacco,gamblingandweapons
...
e\-Print.
82Investments in firms related to environment, social responsibility and corporate governance (ESG) aspects
...
technicalandpracticaladvantagesoveratraditionalmean–varianceapproachthatincorporatesESGpreferences,
...
49(3\), pp. 1736–1753\.
83Multiple testing of a single hypothesis and testing multiple hypotheses are usually done in terms of p\-values.
...
Wang,Z.,Liao,K.,andZhang,Y.(2022\). “DoesESGScreeningEnhanceorDestroyStockPortfolioValue?Evidence
...
ChinesestockmarketfromJuly2012toJune2019\.UsinganovelESGratingdataofCSI300compositestock,we
show that: (i) ESG screening undermines the portfolio value of the equal\-weighted (EW), value\-weighted (VW),
minimumvariance(MVP),andreward\-to\-return(RRT)model.PortfoliomodelsintheHigh\-ESGgrouphavethe
...
84and Out\-of\-Sample Performance on a Large Cohort of Trading Algorithms .” In:The Journal of Investing 25(3\),
pp. 69–80\.
...
measurementthusfarhavelargelyevaluatedondifferentdatasetsorusedinconsistentevaluationmetrics,making
...
85Yoshino, N. and Yuyama, T. (2021\). “Studies of Applied Economics .” In:ESG/Green Investment and Allocation of
...
86presents a case study about two ESG ETFs that are viewed quite differently under various rating lenses, and
