...
2\.2\.18 Validating scenarios and augmented datasets . . . . . . . . . . . . . . . . . . . . . . . . . . . 17
...
7\.2 Connection between Python and R codes . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 33
...
7\.34 Robust numerical methods . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 88
...
46•rstudio.prefs: Set ’RStudio’ Preferences
...
•py\-spy: Sampling profiler for Python programs
47•scalene: high\-performance, high\-precision CPU, GPU, and memory profiler for Python
...
•generalCorr: Generalized Correlations, Causal Paths and Portfolio Selection
•mashr: Multivariate Adaptive Shrinkage
49•MatrixCorrelation: Matrix Correlation Coefficients
...
51•rigr: Regression, Inference, and General Data Analysis Tools in R
...
52•pythae: Unifying Generative Autoencoder implementations in Python
...
53•MSCMT: Multivariate Synthetic Control Method Using Time Series
...
54•Voluptuous: data validation library.
...
567\.16 Data regimes, states and changepoints: analysis and modeling
Collections of resources
List of links:
...
58•robcp: Robust Change\-Point Tests
...
hierarchical data
59•PyMongo \- the Python driver for MongoDB
...
•motifcluster: Motif\-Based Spectral Clustering of Weighted Directed Networks
60•qs: Quick Serialization of R Objects
...
617\.19 Dimensionality reduction
Python
...
62•Rdimtools: Dimension Reduction and Estimation Methods
...
•Stone\-Soup: framework for the development and testing of tracking algorithms
63•stumpy: variety of time series data mining tasks
•tidydr: Unify Dimensionality Reduction Results
...
65•pdp: Partial Dependence Plots
...
66•theft: Tools for Handling Extraction of Features from Time Series
...
•praznik: Tools for Information\-Based Feature Selection and Scoring
67•psd: Adaptive, Sine\-Multitaper Power Spectral Density and Cross Spectrum Estimation
...
68•glum: Generalized linear models
...
•scikit\-learn: machine learning in Python
69•sktime: unified framework for machine learning with time series by UK national institute for data science and
artificial intelligence
...
•ForeCA: Forecastable Component Analysis
70•ForecastComb: Forecast Combination Methods
...
71•robets: Forecasting Time Series with Robust Exponential Smoothing
...
•yardstick: Tidy Characterizations of Model Performance
•yhat: Interpreting Regression Effects
727\.26 Graphs and graphical modeling
Python software implementations
List of packages and/or codes and/or frameworks and/or links:
...
74•Catalyst: PyTorch framework for Deep Learning Research and Development
•catboost: Gradient Boosting on Decision Trees by Yandex
...
75•NannyM: estimate post\-deployment model performance (without access to targets), detect data drift, and
...
76•distillML: Model Distillation and Interpretability Methods for Machine Learning Models
...
777\.29 Machine Learning frameworks (includes Automated ML and hyperparameters
tuning)
Python software implementations
List of packages and/or codes and/or frameworks and/or links:
...
78•Optuna: hyperparameter optimization framework
•PyCaret : machine learning library
...
•karateclub: Framework for Unsupervised Learning on Graphs
79•netrd: etwork {reconstruction, distances, dynamics}
...
80•statnet: Software Tools for the Statistical Analysis of Network Data
...
81•nlopt: nonlinear optimization
...
82•graDiEnt: derivative\-free, optim\-style Stochastic Quasi\-Gradient Differential Evolution optimization
...
•GPyTorch: Gaussian processes for modern machine learning systems.
•MAPIE: scikit\-learn\-compatible module for estimating prediction intervals
83•NGBoost: Natural Gradient Boosting for Probabilistic Prediction
...
84•hmmr: ”Mixture and Hidden Markov Models with R” Datasets and Example Code
...
85•RMixtComp: Mixture Models with Heterogeneous and (Partially) Missing Data
...
86•Gym: ttolkit by openAI for toolkit for developing and comparing reinforcement learning algorithms
...
88•RobustANOVA: Robust One\-Way ANOVA Tests under Heteroscedasticity and Nonnormality
...
90•NonpModelCheck: Model Checking and Variable Selection in Nonparametric Regression
•pcaPP: Robust PCA by Projection Pursuit
...
917\.36 Sensitivity analysis and numerical derivatives
Python software implementations
List of packages and/or codes and/or frameworks and/or links:
•derivative: Numerical differentiation of noisy time series data
...
92•PyProbables: Probabilistic data structures in python
...
93•mlquantify: Algorithms for Class Distribution Estimation
...
•evmix: Extreme Value Mixture Modelling, Threshold Estimation and Boundary Corrected Kernel Density
Estimation
94•ExtremalDep: Extremal Dependence Models
...
•slearn: package linking symbolic representation with scikit\-learn machine learning
95•SR Bench: benchmark framework for symbolic regression
...
Dimensional Data
•fbst: The Full Bayesian Evidence Test, Full Bayesian Significance Test and the e\-Value
97•fdrci: Permutation\-Based FDR Point and Confidence Interval Estimation
...
98•OutliersO3: Draws Overview of Outliers (O3\) Plots
...
101•hcrystalball: unifies the API for most commonly used libraries and modeling techniques for time\-series fore\-
...
103•shrink: Global, Parameterwise and Joint Shrinkage Factor Estimation
•simts: Time Series Analysis Tools
•SLBDD: Statistical Learning for Big Dependent Data
...
104•nlpaug: Data augmentation for NLP
...
105•text2sdg: Detecting UN Sustainable Development Goals in Text
...
List of packages and/or codes and/or frameworks and/or links:
•bootComb: Combine Parameter Estimates via Parametric Bootstrap
1067\.45 Visualization and reporting
Python software implementations
List of packages and/or codes and/or frameworks and/or links:
•Algviz is an algorithm visualization tool for your Python code
...
•torchsde: Differentiable SDE solvers with GPU support and efficient sensitivity analysis
107•tourr: Tour Methods for Multivariate Data Visualisation
...
•ggESDA: Exploratory Symbolic Data Analysis with ’ggplot2’
108•ggfocus: Scales that Focus Specific Levels in your ggplot
...
109•gtsummary: Presentation\-Ready Data Summary and Analytic Result Tables
•heatmaply: Interactive Cluster Heat Maps Using ’plotly’ and ’ggplot2’
•heplots: Visualizing Hypothesis Tests in Multivariate Linear Models
...
110•shinydlplot: Add a Download Button to a ’shiny’ Plot or ’plotly’
...
1118\.2 Research studies with code
...
112Snow (“Machine Learning in Asset Management Part 1: Portfolio Construction Trading Strategies,” 2020\)
...
113•lrsm\_portfolio: Portfolio Construction using Stratified Models
...
1148\.4 R software implementations
List of packages and/or codes and/or frameworks and/or links:
•ASSA: Applied Singular Spectrum Analysis
...
•qlcal: R Bindings to the Calendaring Functionality of ’QuantLib’
115•qrmtools: Tools for Quantitative Risk Management
...
mulation and Probabilistic Description of Agent\-Based Computational Economic Market Models .” In:arXiv
e\-Print .
...
117Bilgili, M. S., Ferconi, M., and Ulitsky, A. (2017\). “Stress Hedging in Portfolio Construction .” In:Risk.
...
118Chen, W., Koo, B., Wang, Y., O’Hare, C., Langrené, N., Toscas, P., and Zhu, Z. (2021b). “Using a stochastic eco\-
...
tionary Max\-Stable Processes and Multidimensional Scaling .” In:Journal of Computational and Graphical Statis\-
tics.
...
Cohort, P., Corbetta, J., and Laachir, I. (2020\). “Analytical scores for stress scenarios .” In:arXiv e\-Print .
...
119De Meer Pardo, F. (2019\). “Enriching Financial Datasets with Generative Adversarial Networks .” MA thesis. Delft
...
Engelke, S. and Ivanovs, J. (2021\). “Sparse Structures for Multivariate Extremes .” In:Annual Review of Statistics
...
Faez, F., Ommi, Y., Baghshah, M. S., and Rabiee, H. R. (2020\). “Deep Graph Generators: A Survey .” In:arXiv
e\-Print .
...
120Flaig, S. and Junike, G. (2022\). “Scenario generation for market risk models using generative neural networks.” In:
arXiv e\-Print .
...
Foramitti, J. (2021\). “AgentPy: A package for agent\-based modeling in Python .” In:Journal of Open Source Software
6(62\), p. 3065\.
...
Franses, P. H. and Bruijn, B. de (2017\). “Benchmarking Judgmentally Adjusted Forecasts .” In:International Journal
...
Fu, B., Kirchbuchner, F., and Kuijper, A. (2020\). “Data augmentation for time series .” In:Proceedings of the 13th
...
Statistics .
121Grundke, P. (2012\). “Further recipes for quantitative reverse stress testing .” In:Journal of Risk Model Validation
6(2\).
...
In:arXiv e\-Print .
Hoffman, J. I. E. (2015\). “Resampling Statistics .” In:Biostatistics for Medical and Biomedical Practitioners . Elsevier,
pp. 655–661\.
...
market forecasting: machine learners vs. financial economists .” In:Expert Systems with Applications 61, pp. 215–
234\.
...
122Javeri, I. Y., Toutiaee, M., Arpinar, I. B., Miller, J. A., and Miller, T. W. (2021\). “Improving Neural Networks for
...
123Kreiss, J.\-P. and Paparoditis, E. (2011\). “Bootstrap methods for dependent data: A review .” In:Journal of the
...
Lim, S. H., Erichson, N. B., Utrera, F., Xu, W., and Mahoney, M. W. (2021\). “Noisy Feature Mixup.” In: arXiv
e\-Print .
...
124Linardi, M., Zhu, Y., Palpanas, T., and Keogh, E. (2018\). “VALMOD: A suite for easy and exact detection of
...
8463\.
Marti, G. (2020b). “Generating Realistic Synthetic Data in Finance: Applications of GANs .” In:IHSMarkitWebinar .
...
e\-Print .
125Mikalsen, K. O., Bianchi, F. M., Soguero\-Ruiz, C., and Jenssen, R. (2018\). “Time Series Cluster Kernel for Learning
...
126Pesenti, S. M., Millossovich, P., and Tsanakas, A. (2019\). “Reverse sensitivity testing: What does it take to break
...
pp. 1–42\.
127Schissler, A. G., Bedrick, E. J., Knudson, A. D., Kozubowski, T. J., Nguyen, T., Petereit, J., Piegorsch, W. W.,
...
128Sun, H., Deng, Z., Chen, H., and Parkes, D. C. (2020\). “Decision\-Aware Conditional GANs for Time Series Data .”
In:arXiv e\-Print .
...
Taylor, L. and Nitschke, G. (2017\). “Improving Deep Learning using Generic Data Augmentation .” In:arXiv e\-Print .
...
129Wang, L., Ma, F., and Liu, G. (2020b). “Forecasting stock volatility in the presence of extreme shocks: Short\-term
...
SSRN e\-Print .
130Zhu, Y., Imamura, M., Nikovski, D., and Keogh, E. (2018\). “Time series chains: A novel tool for time series data
