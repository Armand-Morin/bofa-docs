...
118Bailey, N., Kapetanios, G., and Pesaran, M. H. (2020\). “Measurement of Factor Strength: Theory and Practice .”
In:SSRN e\-Print .
...
In:SSRN e\-Print .
119Bianchi, D. and Tamoni, A. (2020\). “Sparse Predictive Regressions: Statistical Performance and Economic Signif\-
...
Bisaglia, L. and Grigoletto, M. (2021\). “A new time\-varying model for forecasting long\-memory series .” In:Statistical
...
120Castle, J. L., Doornik, J. A., and Hendry, D. F. (2021b). “Selecting a Model for Forecasting .” In:Econometrics 9(3\),
p. 26\.
...
121Cholakov, R. and Kolev, T. (2021\). “Transformers predicting the future. Applying attention in next\-frame and time
...
122Di Fonzo, T. and Girolimetto, D. (2020\). “Cross\-temporal forecast reconciliation: Optimal combination method and
...
123Frenkel, M., Jung, J.\-K., and Rulke, J.\-C. (2021\). “Testing for the rationality of central bank interest rate forecasts .”
...
124Gu, S., Kelly, B., and Xiu, D. (2021\). “Autoencoder asset pricing models .” In:Journal of Econometrics 222(1\),
pp. 429–450\.
Gu, S., Kelly, B. T., and Xiu, D. (2020\). “Empirical asset pricing via machine learning .” In:The Review of Financial
Studies 33 (5\), pp. 2223–2273\.
...
125Hunt, I. (2022\). “In\-sample tests of predictability are superior to pseudo\-out\-of\-sample tests, even when data mining .”
...
with individual assets: Resolving the errors\-in\-variables bias in risk premium estimation .” In:Journal of Financial
...
126Kiefer, D., Bauer, M., and Grimm, F. (2021\). “Univariate Time Series Forecasting: Machine Learning Prediction of
...
Li, L., Kang, Y., and Li, F. (2021a). “Bayesian forecast combination using time\-varying features.” In: arXiv e\-Print .
...
Finance .
127Lichtendahl, K. C. and Winkler, R. L. (2020\). “Why do some combinations perform better than others? ” In:
...
Liu, Z., Zhu, Z., Gao, J., and Xu, C. (2021c). “Forecast Methods for Time Series Data: A Survey .” In:IEEE Access
9, pp. 91896–91912\.
...
McMillan, D. G. (2021a). “Forecasting sector stock market returns .” In:JournalofAssetManagement 22(4\), pp. 291–
300\.
...
128Messmer, M. and Audrino, F. (2020\). “The Lasso and the Factor Zoo \- Expected Returns in the Cross\-Section .” In:
SSRN e\-Print .
...
dependent weighting. ” In:Chaos 29(3\), p. 033128\.
...
129Pesaran, M. H. and Smith, R. (2019\). “The Role of Factor Strength and Pricing Errors for Estimation and Inference
...
130Rapach, D. and Zhou, G. (2022\). “Asset Pricing: Time\-Series Predictability .” In:SSRN e\-Print .
...
Learning Methods .” In:Machine Learning for Asset Management: New Developments and Financial Applications .
...
131Smith, S. C., Bulkley, G., and Leslie, D. S. (2020\). “Equity Premium Forecasts with an Unknown Number of
...
pp. 449–470\.
132Trucı́os, C., Mazzeu, J. H. G., Hallin, M., Hotta, L. K., Pereira, P. L. V., and Zevallos, M. (2021\). “Forecasting
...
133Xu, W., Liu, W., Wang, L., Xia, Y., Bian, J., Yin, J., and Liu, T.\-Y. (2022\). “HIST: A Graph\-based Framework
...
Yin, A. (2021\). “Equity premium prediction: keep it sophisticatedly simple .” In:Quantitative Finance and Economics
5(2\), pp. 264–286\.
...
In:arXiv e\-Print .
134Appendix A: Overviews of investment processes and models in QWIM
References
List of references:
Coqueret and Guida ( Machine Learning for Factor Investing: R Version , 2020\)
Dixon et al. ( Machine Learning in Finance: from theory to practice , 2020\)
...
135Appendix C: Incorporating comparison of portfolio metrics using bench\-
mark portfolios
...
136Python and R packages/codes for portfolio optimization
...
137Python and R packages/codes for portfolio metrics and performance evaluation
•bt
•empyrical
•ffn
•JFE
...
138•expected covariance matrix is calculated based on forecasted values available at June 20, 2019 and obtained
using the forecasted model trained on given training dataset (which is from 1990 to 2017\)
