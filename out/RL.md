...
1\.2 Using RLinQWIM . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 5
1\.3 Using RLinQWIM : Goals\-based investing . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 6
1\.4 Using RLinQWIM : Asset allocation and portfolio construction . . . . . . . . . . . . . . . . . . . . 7
...
reward: describes the goal of a RLproblem, and it is a scalar value (obtained from environment) whose
...
4Figure 1: Taxonomy of einforcement learning algorithms
...
to solve for Goal Based Investing GBI, with the solution converging to the solution obtained using dynamic
programming
...
GIRL extends G\-Learner within context of Inverse Reinforcement Learning IRL, where rewards collected
by agent are not observed, and should instead be inferred
•Fischer ( Reinforcement learning in financial markets \- a survey , 2018\) :RLcombines “prediction" and “port\-
folio construction"
...
•Sato (“Model\-Free Reinforcement Learning for Financial Portfolios: A Brief Survey,” 2019\) : model\-free RL
for financial portfolios
5•Irlam (“Machine learning for retirement planning,” 2020\) :RLis capable of handling real\-world complexity of
financial planning; taxes, inflation, longevity, etc.
•Irlam (“Machine learning for retirement planning,” 2020\) : financial and retirement planning via DRLoutper\-
...
targeting,” 2021\) : bridges the gap between DRLand Modern Portfolio Theory, with DRLmapping directly
market conditions to actions by design
•Benhamou et al. (“Adaptive learning for financial markets mixing model\-based and model\-free RL for volatility
targeting,” 2021\) : augmented asset management via DRL
...
based on deep RLare very data\-hungry, slow to train, very sensitive to both the inputs and hyperparameters, and
usually rely heavily on various heuristics.
1\.3 Using RLinQWIM: Goals\-based investing
Goal Based Investing GBIis an investment approach where performance is measured by the success of investments
...
Given current state\-of\-the\-art for RL, incorporating multiple goals with their corresponding priority levels within
aRL\-based solution for GBIappears to be a significant modeling challenge. One possible solution may leverage
hierarchical RLand curiosity\-driven exploration.
61\.4 Using RLinQWIM: Asset allocation and portfolio construction
...
72 Relevant references
2\.1 Main references
List of references:
Aliaga\-Diaz et al. ( Vanguard’s Life\-Cycle Investing Model (VLCM): A general portfolio framework for goals\-based
investing , 2021\)
...
8Mulvey et al. (“A Factor\- and Goal\-Driven Model for Defined Benefit Pensions: Setting Realistic Benefits,”
2019\)
Noguer i Alonso and Srivastava (“Deep Reinforcement Learning for Asset Allocation in US Equities,” 2020\)
...
Parker (“Portfolio Selection in a Goal\-Based Setting,” 2016\)
Parker (“Achieving Goals While Making an Impact: Balancing Financial Goals with Impact Investing,” 2021\)
9Parker (“Multi\-Period Goals\-Based Portfolio Optimization,” 2021\)
Parker (“Allocation of wealth both within and across goals: a practitioner guide,” 2020\)
Parker (“A Goals\-Based Theory of Utility,” 2021\)
...
10Gasperov et al. (“Adaptive rolling window selection for minimum variance portfolio estimation based on rein\-
...
11Yashaswi (“Deep Reinforcement Learning for Portfolio Optimization using Latent Feature State Space (LFSS)
Module,” 2021\)
...
12Xing (“Learning and Exploiting Multiple Subgoals for Fast Exploration in Hierarchical Reinforcement Learning,”
2019\)
...
Rewards,” 2016\)
132\.2\.6 Testing and comparison procedures for investment portfolios
References:
...
14Tayali (“A novel backtesting methodology for clustering in mean–variance portfolio optimization,” 2020\)
...
Source: AlphaPy
21Figure 3: Examples of architecture of coding framework: Greykite
Source: Geykite
...
22Figure 5: Examples of major components of coding framework (top) and UML diagrams (bottom)
23Figure 6: Financial Machine Learning in Portfolio Construction
...
113References
Abbeel, P. and Ng, A. Y. (2017\). “Inverse Reinforcement Learning .” In:Encyclopedia of machine learning and data
mining . Ed. by C. Sammut and G. I. Webb. Boston, MA: Springer US, pp. 678–682\.
...
brief survey .” In:IEEE Signal Processing Magazine 34(6\), pp. 26–38\.
...
Planning (with Python Bindings) .” In:Journal of Machine Learning Research .
Bartram, S. M., Branke, J., De Rossi, G., and Motahari, M. (2021\). “Machine Learning for Active Portfolio Man\-
agement .” In:The Journal of Financial Data Science 3(3\), pp. 9–30\.
...
markets mixing model\-based and model\-free RL for volatility targeting .” In:arXiv e\-Print .
...
114Benhamou, E., Saltiel, D., Ungari, S., and Mukhopadhyay, A. (2020\). “Time your hedge with Deep Reinforcement
...
Implementations .” In:arXiv e\-Print .
...
cations .” In:Proceedings of the AAAI Conference on Artificial Intelligence 33, pp. 7749–7758\.
...
for Data Processing and Analytics.” In: arXiv e\-Print .
...
The Journal of Financial Data Science 3(1\), pp. 10–27\.
115Cao, J., Chen, J., Hull, J. C., and Poulos, Z. (2020\). “Deep Hedging of Derivatives Using Reinforcement Learning .”
In:SSRN e\-Print .
Carbonneau, A. (2020\). “Deep Hedging of Long\-Term Financial Derivatives .” In:arXiv e\-Print .
Carbonneau, A. and Godin, F. (2021\). “Equal risk pricing of derivatives with deep hedging .” In:Quantitative Finance
21(4\), pp. 593–608\.
...
Charpentier, A., Elie, R., and Remlinger, C. (2020\). “Reinforcement Learning in Economics and Finance .” In:arXiv
e\-Print .
...
Coache, A. and Jaimungal, S. (2022\). “Reinforcement Learning with Dynamic Convex Risk Measures.” In: arXiv
e\-Print .
...
forcement learning algorithms using Bayesian optimization with behavioral cloning.” In: arXiv e\-Print .
Cuschieri, N., Vella, V., and Bajada, J. (2021\). “TD3\-Based Ensemble Reinforcement Learning for Financial Port\-
folio Optimisation .” In:31st International Conference on Automated Planning and Scheduling .
...
Learning Research .” In:Journal of Machine Learning Research 22(131\), pp. 1–5\.
...
116Das, S. R., Ostrov, D. N., Casanova, A., Radhakrishnan, A., and Srivastav, D. (2022b). “Optimal Goals\-Based
...
Using Deep Reinforcement Learning.” In: arXiv e\-Print .
Du, J., Jin, M., Kolm, P. N., Ritter, G., Wang, Y., and Zhang, B. (2020\). “Deep Reinforcement Learning for Option
Replication and Hedging .” In:The Journal of Financial Data Science 22(44\), pp. 44–57\.
Dulac\-Arnold, G., Levine, N., Mankowitz, D. J., Li, J., Paduraru, C., Gowal, S., and Hester, T. (2021\). “An empirical
investigation of the challenges of real\-world reinforcement learning .” In:arXiv e\-Print .
...
Reinforcement Learning .” In:Journal of Artificial Intelligence Research 71, pp. 925–951\.
...
117Garau\-Luis, J. J., Crawley, E., and Cameron, B. (2021\). “Evaluating the progress of Deep Reinforcement Learning
...
ance portfolio estimation based on reinforcement learning .” In:43rd International Convention on Information,
Communication and Electronic Technology (MIPRO) . IEEE.
...
pirical Approach.” In: arXiv e\-Print .
...
distribution .” In:Quantitative Finance , pp. 1–15\.
...
Quantitative Finance 19(9\), pp. 1543–1553\.
...
for Asset Allocation Recommendations.” In: arXiv e\-Print .
...
Hambly, B. M., Xu, R., and Yang, H. (2021\). “Recent Advances in Reinforcement Learning in Finance .” In:SSRN
e\-Print .
...
environment for trading.” In: arXiv e\-Print .
118Ho, J., Tumkaya, T., Aryal, S., Choi, H., and Claridge\-Chang, A. (2019\). “Moving beyond P values: data analysis
...
for Financial Portfolio Management .” In:arXiv e\-Print .
...
Reinforcement Learning Algorithms .” In:Thirty\-seventh International Conference on Machine Learning ICML .
...
119Kakushadze, Z. and Yu, W. (2018b). “Decoding stock market with quant alphas .” In:Journal of Asset Management ,
pp. 1–11\.
...
and Perspectives.” In: arXiv e\-Print .
...
In:arXiv e\-Print .
Kolm, P. N. and Ritter, G. (2020\). “Modern Perspectives on Reinforcement Learning in Finance .” In:The Journal
...
Reinforcement Learning for Long\-Horizon Tasks with Delayed Rewards .” In:arXiv e\-Print .
...
Gomez, A. (2019\). “RL: Generic reinforcement learning codebase in TensorFlow .” In:The Journal of Open Source
Software 4(42\), p. 1524\.
...
120Li, Z., Liu, X.\-Y., Zheng, J., Wang, Z., Walid, A., and Guo, J. (2021c). “FinRL\-Podracer: High Performance and
...
Reinforcement Learning: Evidence from the Taiwan 50 Index .” In:SSRN e\-Print .
...
densities with application to reinforcement learning.” In: arXiv e\-Print .
...
Ma, Y. c. (, Wang, Z., and Fleiss, A. (2021\). “Deep Q\-Learning for Trading Cryptocurrency .” In:The Journal of
Financial Data Science 3(3\), pp. 121–127\.
...
Deep Reinforcement Learning for Portfolio Management.” In: arXiv e\-Print .
...
121Mosavi, A., Ghamisi, P., Faghan, Y., Duan, P., ardabili, sina faizollahzadeh, Salwana, E., and Band, S. (2020\).
“Comprehensive Review of Deep Reinforcement Learning Methods and Applications in Economics .” In:SSRN
e\-Print .
...
Open Problems.” In: arXiv e\-Print .
...
Model\-based Reinforcement Learning .” In:arXiv e\-Print .
...
distributed multi\-agent reinforcement learning.” In: arXiv e\-Print .
...
Learning in R .” In:The Journal of Open Source Software 4(38\), p. 1087\.
...
122Rafati, J. and Marcia, R. F. (2018\). “Deep Reinforcement Learning via L\-BFGS Optimization .” In:arXiv e\-Print .
...
Roncalli, T. (2019\). “How Machine Learning Can Improve Portfolio Allocation of Robo\-Advisors .” In:SwissQuant
Conference .
...
(2021\). “Pretraining Representations for Data\-Efficient Reinforcement Learning.” In: arXiv e\-Print .
...
Shalett, L. (2015\). AnOutcomes\-OrientedApproachtoAlternatives . Tech. rep. Morgan Stanley Wealth Management.
...
Learning for Trade Execution .” In:arXiv e\-Print .
...
123Tarbouriech, J., Domingues, O. D., Menard, P., Pirotta, M., Valko, M., and Lazaric, A. (2021\). “Adaptive Multi\-Goal
Exploration.” In: arXiv e\-Print .
...
for Stock Trading .” In:arXiv e\-Print .
...
An Ensemble Strategy .” In:SSRN e\-Print .
...
124Yashaswi, K. (2021\). “Deep Reinforcement Learning for Portfolio Optimization using Latent Feature State Space
...
the Importance of Hyperparameter Optimization for Model\-based Reinforcement Learning.” In: arXiv e\-Print .
...
Zhang, H. and Yu, T. (2020\). “Taxonomy of Reinforcement Learning Algorithms .” In:Deep Reinforcement Learning .
...
Based Recommendations via Multi\-goals Abstraction .” In:arXiv e\-Print .
